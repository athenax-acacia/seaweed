...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,0,1,3
# to recreate, then copy the file 'moment_0013.py' on top of this one.
...
def moment_0013(delta_v, mu, sigma):
        ...
        (mu3 - sigma_30 + sigma_33)) - delta_v1 * (
            ...
            (mu3 + sigma_30 + sigma_33)) + mu3 * (
                ...
                (mu2 * mu3 + sigma_32)) + sigma_32 * (
                    mu3**2 + sigma_33) + 2 * sigma_33 * (mu2 * mu3 + sigma_32)


def latex_0013():
    return r"""
-{\left({\left(\sigma_{33} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
...
{\left({\left(\sigma_{33} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{3} - \sigma_{33}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_1} +
{\left({\left(\mu_{2} \mu_{3} + \sigma_{32}\right)} \mu_{3} + \mu_{3} \sigma_{32} + \mu_{2} \sigma_{33}\right)} \mu_{3}
+ {\left(\mu_{3}^{2} + \sigma_{33}\right)} \sigma_{32} + 2 \, {\left(\mu_{2} \mu_{3} + \sigma_{32}\right)} \sigma_{33}
"""
