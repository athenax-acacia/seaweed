...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,0,2,1
# to recreate, then copy the file 'moment_0021.py' on top of this one.
...
def moment_0021(delta_v, mu, sigma):
                ...
                (mu3 - sigma_30 + sigma_33)) + delta_v1**2 * (
                    ...
                    * sin(2 * mu0 - 4 * sigma_30) + (mu3 - 2 * sigma_33) *
                    ...
                    (-sigma_20 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                     ...
                     (mu2 - sigma_32) * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2)
                     * cos(mu0 - sigma_30)) *
                    (mu3 + sigma_30 + sigma_33)) + 2 * mu2 * sigma_32 + mu3 * (
                        mu2**2 + sigma_22)
...
\sigma_{30} + \sigma_{33}\right)}\right)} {\Delta v_0} - 2 \, {\left(\sigma_{32} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)}\right)} {\Delta v_1} +
{\left(\mu_{2}^{2} + \sigma_{22}\right)} \mu_{3} + 2 \, \mu_{2} \sigma_{32}
"""
