...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,0,2,2
# to recreate, then copy the file 'moment_0022.py' on top of this one.
...
def moment_0022(delta_v, mu, sigma):
            ...
            (mu3 + 2 * sigma_30 + 2 * sigma_33)) / 2 - 2 * delta_v1 * (
                ...
                (mu3 + sigma_30 + sigma_33)) + mu3 * (
                    ...
                    (mu2**2 + sigma_22)) + 2 * sigma_32 * (
                        mu2 * mu3 + sigma_32) + sigma_33 * (mu2**2 + sigma_22)
...
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 2 \, {\left({\left(\sigma_{32} e^{\left(-\mu_{3} -
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_0} - 2 \, {\left({\left(\sigma_{32}
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_1} + {\left({\left(\mu_{2}^{2} +
\sigma_{22}\right)} \mu_{3} + 2 \, \mu_{2} \sigma_{32}\right)} \mu_{3} + 2 \, {\left(\mu_{2} \mu_{3} +
\sigma_{32}\right)} \sigma_{32} + {\left(\mu_{2}^{2} + \sigma_{22}\right)} \sigma_{33}
"""
