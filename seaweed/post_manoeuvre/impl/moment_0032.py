...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,0,3,2
# to recreate, then copy the file 'moment_0032.py' on top of this one.
...
def moment_0032(delta_v, mu, sigma):
    ...
    return delta_v0**3 * (
        ...
        (mu3 - 2 * sigma_30 + 2 * sigma_33)) - 3 * delta_v0 * (
            ...
            (-sigma_30 * exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33 / 2) *
             sin(mu0 - 3 * sigma_30) +
             (mu3 - 3 * sigma_33) * exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33
            ...
            (sigma_32 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
             ...
             (mu3 + 2 * sigma_30 + 2 * sigma_33)) *
            (mu3 + 2 * sigma_30 + 2 * sigma_33)) / 2 + 3 * delta_v1**2 * (
                sigma_32 *
                (mu3 - 2 * sigma_33) * exp(-2 * mu3 + 2 * sigma_33) +
                sigma_33 *
                (mu2 - 2 * sigma_32) * exp(-2 * mu3 + 2 * sigma_33) +
                ...
                (mu3 + sigma_30 + sigma_33)) + mu3 * (
                    ...
                    (mu2**2 + sigma_22)) + 3 * sigma_32 * (
                        2 * mu2 * sigma_32 + mu3 *
                        (mu2**2 + sigma_22)) + sigma_33 * (2 * mu2 * sigma_22 +
                                                           mu2 *
                                                           (mu2**2 + sigma_22))
...
\sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{4} \, {\left(\sigma_{33} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
\, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{4} \, {\left(\sigma_{33} \cos\left(\mu_{0} - 3 \,
...
{\left(\mu_{3} - 3 \, \sigma_{33}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} - 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \, {\left(\sigma_{33} e^{\left(-3 \, \mu_{3} -
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} -
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \, {\left(\sigma_{33}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{2} \, {\left({\left(\mu_{3} - 2 \, \sigma_{33}\right)}
...
\sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} - \frac{3}{2} \,
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_0}^{2} + 3 \,
...
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_0} {\Delta v_1} + \frac{3}{2} \,
{\left({\left(\mu_{3} - 2 \, \sigma_{33}\right)} \sigma_{32} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{2} - 2 \, \sigma_{32}\right)} \sigma_{33} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} {\left(\mu_{3} + 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{32} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} + \frac{3}{2} \, {\left({\left(\sigma_{32} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right)\right)} \sigma_{32} + {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{20} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{33}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left({\left(\sigma_{22} e^{\left(-\mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{20}
...
\sigma_{32}\right)}\right)} {\left(\mu_{3} - \sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{20}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
\sigma_{33}\right)} + {\left(\mu_{2} - \sigma_{32}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{32}\right)} {\left(\mu_{3} - \sigma_{30} +
\sigma_{33}\right)} + 2 \, {\left(\sigma_{32} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{33}\right)} {\Delta v_0} - 3 \, {\left({\left({\left(\sigma_{22}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{20} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{2} + \sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{33}\right)} {\Delta v_1} +
{\left({\left({\left(\mu_{2}^{2} + \sigma_{22}\right)} \mu_{2} + 2 \, \mu_{2} \sigma_{22}\right)} \mu_{3} + 3 \,
{\left(\mu_{2}^{2} + \sigma_{22}\right)} \sigma_{32}\right)} \mu_{3} + 3 \, {\left({\left(\mu_{2}^{2} +
\sigma_{22}\right)} \mu_{3} + 2 \, \mu_{2} \sigma_{32}\right)} \sigma_{32} + {\left({\left(\mu_{2}^{2} +
\sigma_{22}\right)} \mu_{2} + 2 \, \mu_{2} \sigma_{22}\right)} \sigma_{33}
"""
