...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,0,4,1
# to recreate, then copy the file 'moment_0041.py' on top of this one.
...
def moment_0041(delta_v, mu, sigma):
                    ...
                    * cos(mu0 - 3 * sigma_30) +
                    ...
                    (mu3 + 2 * sigma_30 + 2 * sigma_33)) + 3 * delta_v1**2 * (
                        ...
                        (mu3 + sigma_30 + sigma_33)) + mu3 * (
                            ...
                            (mu2**2 + sigma_22)) + 4 * sigma_32 * (
                                2 * mu2 * sigma_22 + mu2 * (mu2**2 + sigma_22))
...
\sigma_{33}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} - 4 \, \sigma_{30} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4
\, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_1}^{4} + {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
- 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} - 3 \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3}
...
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} - 3 \, {\left(\sigma_{32} \cos\left(\mu_{0} - 3 \,
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} +
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + 3 \, {\left(\sigma_{32} \cos\left(3 \,
...
v_1} - 3 \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)}
\sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{20} \cos\left(3 \, \mu_{0} - 9 \,
...
\sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - 3 \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} - \frac{1}{2}
...
\, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - 3 \, {\left(\sigma_{32} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{2} - 3 \, \sigma_{32}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \sigma_{20} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} +
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{3} - {\left(\sigma_{32} \cos\left(3 \, \mu_{0} - 9 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
...
{\left(\mu_{3} + 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{3} + 3 \, {\left(2 \, {\left(\mu_{2}
- 2 \, \sigma_{32}\right)} \sigma_{32} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} + 2 \,
\sigma_{32}\right)} {\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \, \sigma_{33}\right)}\right)}
{\Delta v_0}^{2} - 3 \, {\left({\left(\sigma_{22} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \,
...
\sigma_{30} + 2 \, \sigma_{33}\right)} + 2 \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} -
...
\sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0}^{2} + 6 \, {\left({\left(\sigma_{22} e^{\left(-2 \, \mu_{3}
- 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) + {\left(2 \, \sigma_{20}
...
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0} {\Delta v_1} + 3 \, {\left(2
...
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} + 3 \, {\left({\left(\sigma_{22} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_1}^{2} - 4 \, {\left({\left({\left(\sigma_{22}
...
\sigma_{32}\right)} {\Delta v_0} - 4 \, {\left({\left({\left(\sigma_{22} \cos\left(\mu_{0} - \sigma_{30}\right)
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} -
\sigma_{30}\right)\right)} \sigma_{22}\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} + 3 \,
...
{\left(\mu_{2}^{2} + \sigma_{22}\right)} \sigma_{22}\right)} \mu_{3} + 4 \, {\left({\left(\mu_{2}^{2} +
\sigma_{22}\right)} \mu_{2} + 2 \, \mu_{2} \sigma_{22}\right)} \sigma_{32}
"""
