...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,0,5,0
# to recreate, then copy the file 'moment_0050.py' on top of this one.
...
def moment_0050(delta_v, mu, sigma):
    ...
    ) * sin(5 * mu0 - 25 * sigma_30) / 16 + 5 * delta_v0**5 * exp(
        -5 * mu3 - 9 * sigma_00 / 2 + 25 * sigma_33 / 2
    ) * sin(3 * mu0 - 15 * sigma_30) / 16 - 5 * delta_v0**5 * exp(
        -5 * mu3 - sigma_00 / 2 + 25 * sigma_33 /
        2) * sin(mu0 - 5 * sigma_30) / 8 - 5 * delta_v0**4 * delta_v1 * exp(
            -5 * mu3 - 25 * sigma_00 / 2 + 25 * sigma_33 / 2) * cos(
                5 * mu0 - 25 * sigma_30
                ...
                * sin(4 * mu0 - 16 * sigma_30)
                ...
                2 * sigma_20 * exp(-4 * mu3 - 2 * sigma_00 + 8 * sigma_33)
                * cos(2 * mu0 - 8 * sigma_30)
                + (mu2 - 4 * sigma_32)
                * exp(-4 * mu3 - 2 * sigma_00 + 8 * sigma_33)
                * sin(2 * mu0 - 8 * sigma_30)
                ...
                * (mu2 - 2 * sigma_20 + 2 * sigma_32)
                ...
                25 * sigma_33 / 2) * cos(
                    ...
                    -5 * mu3 - 9 *
                    sigma_00 / 2 + 25 * sigma_33 / 2) * cos(
                        3 * mu0 - 15 * sigma_30) / 16 - 5 * delta_v1**5 * exp(
                            -5 * mu3 -
                            sigma_00 / 2 + 25 *
                            sigma_33 / 2
                        ) * cos(mu0 - 5 * sigma_30) / 8 + 15 * delta_v1**4 * (
                            mu2 - 4 * sigma_32
                        ) * exp(
                            -4 * mu3 + 8 * sigma_33
                        ) / 8 + 5 * delta_v1**4 * (
                            ...
                            * exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33 / 2) *
                            ...
                            (mu2 + sigma_20 + sigma_32)) + mu2 * (
                                mu2 * (2 * mu2 * sigma_22 + mu2 *
                                       (mu2**2 + sigma_22)) + 3 * sigma_22 *
                                (mu2**2 + sigma_22)) + 4 * sigma_22 * (
                                    2 * mu2 * sigma_22 + mu2 *
                                    (mu2**2 + sigma_22))
...
def latex_0050():
    return r"""
-\frac{5}{8} \, {\Delta v_0}^{4} {\Delta v_1} \cos\left(\mu_{0} - 5 \, \sigma_{30}\right) e^{\left(-5 \, \mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} - \frac{5}{4} \, {\Delta v_0}^{2} {\Delta v_1}^{3}
\cos\left(\mu_{0} - 5 \, \sigma_{30}\right) e^{\left(-5 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{25}{2} \,
\sigma_{33}\right)} - \frac{5}{8} \, {\Delta v_1}^{5} \cos\left(\mu_{0} - 5 \, \sigma_{30}\right) e^{\left(-5 \, \mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} + \frac{15}{16} \, {\Delta v_0}^{4} {\Delta v_1}
\cos\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right) e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \,
\sigma_{33}\right)} + \frac{5}{8} \, {\Delta v_0}^{2} {\Delta v_1}^{3} \cos\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right)
e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} - \frac{5}{16} \, {\Delta
...
\frac{5}{16} \, {\Delta v_0}^{5} e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right) - \frac{5}{8} \, {\Delta v_0}^{3} {\Delta v_1}^{2}
e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 15 \,
\sigma_{30}\right) - \frac{15}{16} \, {\Delta v_0} {\Delta v_1}^{4} e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00}
+ \frac{25}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right) - \frac{5}{8} \, {\Delta
v_0}^{5} e^{\left(-5 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 5
\, \sigma_{30}\right) - \frac{5}{4} \, {\Delta v_0}^{3} {\Delta v_1}^{2} e^{\left(-5 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 5 \, \sigma_{30}\right) - \frac{5}{8} \, {\Delta
v_0} {\Delta v_1}^{4} e^{\left(-5 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - 5 \, \sigma_{30}\right) + \frac{15}{8} \, {\Delta v_0}^{4} {\left(\mu_{2} - 4 \, \sigma_{32}\right)}
e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} + \frac{15}{4} \, {\Delta v_0}^{2} {\Delta v_1}^{2} {\left(\mu_{2} - 4
\, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} + \frac{15}{8} \, {\Delta v_1}^{4}
{\left(\mu_{2} - 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} - \frac{5}{2} \,
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + \frac{5}{8} \,
...
\, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + 5 \, {\left(2 \,
...
\, {\left(4 \, \sigma_{20} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} +
8 \, \sigma_{33}\right)} + {\left(\mu_{2} - 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} -
\frac{15}{4} \, {\left({\left(\mu_{2} - 4 \, \sigma_{32}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)
e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 4 \, \sigma_{20} e^{\left(-4 \, \mu_{3} - 8 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2}
{\Delta v_1}^{2} + 5 \, {\left(2 \, \sigma_{20} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3}
- 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{2} - 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} - 2 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta
v_1}^{3} + \frac{5}{2} \, {\left(4 \, \sigma_{20} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \,
...
{\Delta v_1}^{3} + \frac{5}{2} \, {\left({\left(\mu_{2} - 4 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 8 \,
\sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 2 \, \sigma_{20} e^{\left(-4
\, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)}
{\Delta v_1}^{4} + \frac{5}{8} \, {\left({\left(\mu_{2} - 4 \, \sigma_{32}\right)} \cos\left(4 \, \mu_{0} - 16 \,
...
{\Delta v_1}^{4} + \frac{5}{2} \, {\left(\sigma_{22} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2}
...
\sigma_{32}\right)}\right)} {\Delta v_0}^{3} - \frac{15}{2} \, {\left(\sigma_{22} e^{\left(-3 \, \mu_{3} - \frac{1}{2}
...
\, \sigma_{32}\right)}\right)} {\Delta v_0}^{3} - \frac{15}{2} \, {\left(\sigma_{22} \cos\left(\mu_{0} - 3 \,
...
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{15}{2} \, {\left(\sigma_{22}
...
v_1} - \frac{15}{2} \, {\left(\sigma_{22} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{20} \cos\left(3 \, \mu_{0} -
9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{2} - 3 \, \sigma_{32}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - 3 \, \sigma_{20} + 3 \,
\sigma_{32}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{15}{2} \, {\left(\sigma_{22} e^{\left(-3 \, \mu_{3} -
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} -
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{15}{2} \, {\left(\sigma_{22}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\frac{5}{2} \, {\left(\sigma_{22} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{2} + 3 \, \sigma_{20} + 3 \,
\sigma_{32}\right)}\right)} {\Delta v_1}^{3} + 5 \, {\left(2 \, {\left(\mu_{2} - 2 \, \sigma_{32}\right)} \sigma_{22}
e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} + 2 \, \sigma_{32}\right)} {\left(\mu_{2} - 2
\, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} - 5 \,
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{20} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{22}\right)} {\Delta v_0}^{2} + 10 \, {\left({\left(\sigma_{22} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
\sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_0} {\Delta v_1} + 5 \, {\left(2 \, {\left(\mu_{2} - 2 \,
\sigma_{32}\right)} \sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} + 2 \,
\sigma_{32}\right)} {\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)}\right)}
{\Delta v_1}^{2} + 5 \, {\left({\left(\sigma_{22} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \,
\mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \cos\left(2 \,
\mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \,
\sigma_{20} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} {\left(\mu_{2} + 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\left(\mu_{2} + 2 \,
\sigma_{20} + 2 \, \sigma_{32}\right)} + 2 \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} -
4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{20}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_1}^{2} - 5 \, {\left({\left({\left(\sigma_{22}
...
\sigma_{22}\right)} {\Delta v_0} - 5 \, {\left({\left({\left(\sigma_{22} \cos\left(\mu_{0} - \sigma_{30}\right)
...
+ \sigma_{20} + \sigma_{32}\right)} + 2 \, {\left({\left(\mu_{2} - \sigma_{32}\right)} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{20}
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} -
\sigma_{30}\right)\right)} \sigma_{22}\right)} {\left(\mu_{2} + \sigma_{20} + \sigma_{32}\right)} + 3 \,
...
{\left({\left({\left(\mu_{2}^{2} + \sigma_{22}\right)} \mu_{2} + 2 \, \mu_{2} \sigma_{22}\right)} \mu_{2} + 3 \,
{\left(\mu_{2}^{2} + \sigma_{22}\right)} \sigma_{22}\right)} \mu_{2} + 4 \, {\left({\left(\mu_{2}^{2} +
\sigma_{22}\right)} \mu_{2} + 2 \, \mu_{2} \sigma_{22}\right)} \sigma_{22}
"""
