...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,1,0,3
# to recreate, then copy the file 'moment_0103.py' on top of this one.
...
def moment_0103(delta_v, mu, sigma):
        ...
        (mu3 + sigma_30 + sigma_33)) + delta_v1 * (
            ...
            (mu3 - sigma_30 + sigma_33)) + mu3 * (
                ...
                (mu1 * mu3 + sigma_31)) + sigma_31 * (
                    mu3**2 + sigma_33) + 2 * sigma_33 * (mu1 * mu3 + sigma_31)
...
{\left({\left(\mu_{1} \mu_{3} + \sigma_{31}\right)} \mu_{3} + \mu_{3} \sigma_{31} + \mu_{1} \sigma_{33}\right)} \mu_{3}
+ {\left(\mu_{3}^{2} + \sigma_{33}\right)} \sigma_{31} + 2 \, {\left(\mu_{1} \mu_{3} + \sigma_{31}\right)} \sigma_{33}
"""
