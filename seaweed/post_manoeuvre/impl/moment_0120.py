...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,1,2,0
# to recreate, then copy the file 'moment_0120.py' on top of this one.
...
def moment_0120(delta_v, mu, sigma):
...
def latex_0120():
    return r"""
-\frac{1}{4} \, {\Delta v_0}^{3} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \frac{1}{4} \, {\Delta v_0} {\Delta v_1}^{2} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
\frac{1}{4} \, {\Delta v_0}^{3} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \frac{3}{4} \, {\Delta v_0} {\Delta v_1}^{2} \cos\left(3 \, \mu_{0} -
9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} -
\frac{3}{4} \, {\Delta v_0}^{2} {\Delta v_1} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + \frac{1}{4} \, {\Delta v_1}^{3} e^{\left(-3 \,
\mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \,
\sigma_{30}\right) + \frac{1}{4} \, {\Delta v_0}^{2} {\Delta v_1} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right) + \frac{1}{4} \, {\Delta v_1}^{3}
e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \,
\sigma_{30}\right) + \frac{1}{2} \, {\Delta v_0}^{2} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} +
2 \, \sigma_{33}\right)} + \frac{1}{2} \, {\Delta v_1}^{2} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)} - \frac{1}{2} \, {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \cos\left(2 \,
...
\sigma_{30}\right)\right)} {\Delta v_0}^{2} + {\left(2 \, \sigma_{20} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} {\Delta v_0}^{2} + 2 \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \cos\left(2 \,
\mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \,
\sigma_{20} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1} + {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1} + \frac{1}{2} \, {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)}
...
\sigma_{30}\right)\right)} {\Delta v_1}^{2} - {\left(2 \, \sigma_{20} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{2} - 2 \, \sigma_{32}\right)}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} {\Delta v_1}^{2} - {\left(\sigma_{22} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} + \sigma_{20} + \sigma_{32}\right)}\right)} {\Delta v_0} -
...
{\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)}\right)} {\Delta v_0} - 2 \, {\left(\sigma_{21} \cos\left(\mu_{0} -
...
\sigma_{32}\right)}\right)} {\Delta v_1} + {\left(\sigma_{22} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
{\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \mu_{2} + \mu_{2} \sigma_{21} + \mu_{1} \sigma_{22}
"""
