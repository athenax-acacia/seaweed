...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,1,2,1
# to recreate, then copy the file 'moment_0121.py' on top of this one.
...
def moment_0121(delta_v, mu, sigma):
                    ...
                    * cos(mu0 - 3 * sigma_30) + (mu3 - 3 * sigma_33) *
                    ...
                    (mu3 + sigma_30 + sigma_33)) + mu3 * (
                        ...
                        (mu1 * mu2 + sigma_21)) + sigma_31 * (
                            mu2**2 + sigma_22) + 2 * sigma_32 * (mu1 * mu2 +
                                                                 sigma_21)


def latex_0121():
    return r"""
-\frac{1}{4} \, {\left({\left(\mu_{3} - 3 \, \sigma_{33}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3
...
\mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} + \frac{1}{4} \, {\left(\sigma_{30} \cos\left(\mu_{0} - 3 \,
...
{\Delta v_0}^{2} {\Delta v_1} - \frac{1}{4} \, {\left({\left(\mu_{3} - 3 \, \sigma_{33}\right)} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} -
...
v_1}^{2} + \frac{1}{4} \, {\left(\sigma_{30} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
...
\sigma_{30} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \, {\left({\left(\mu_{1} - 2 \,
\sigma_{31}\right)} {\left(\mu_{3} + 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{31} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + {\left(\sigma_{32} e^{\left(-2
...
\sigma_{33}\right)}\right)} {\Delta v_0}^{2} + 2 \, {\left(\sigma_{32} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)}
...
v_1} + {\left(\sigma_{31} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} -
...
2 \, \sigma_{30} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1} + \frac{1}{2} \, {\left(\sigma_{31}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 2 \, \sigma_{30} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} + \frac{1}{2} \, {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)}
{\left(\mu_{3} + 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{31} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - {\left(\sigma_{32} e^{\left(-2 \, \mu_{3} - 2 \,
...
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} - {\left({\left(\sigma_{22} \cos\left(\mu_{0} - \sigma_{30}\right)
...
+ \sigma_{30} + \sigma_{33}\right)} + 2 \, {\left({\left(\mu_{2} - \sigma_{32}\right)} \cos\left(\mu_{0} -
...
\sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0} - 2 \, {\left({\left(\sigma_{21} e^{\left(-\mu_{3} -
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0} - 2 \, {\left({\left(\sigma_{21}
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_1} + {\left({\left(\sigma_{22}
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} -
...
\sigma_{20} + \sigma_{32}\right)}\right)} {\left(\mu_{3} - \sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{20}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
\sigma_{33}\right)} + {\left(\mu_{2} - \sigma_{32}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_1} +
{\left({\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \mu_{2} + \mu_{2} \sigma_{21} + \mu_{1} \sigma_{22}\right)} \mu_{3}
+ {\left(\mu_{2}^{2} + \sigma_{22}\right)} \sigma_{31} + 2 \, {\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \sigma_{32}
"""
