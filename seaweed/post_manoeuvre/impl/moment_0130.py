...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,1,3,0
# to recreate, then copy the file 'moment_0130.py' on top of this one.
...
def moment_0130(delta_v, mu, sigma):
                    ...
                    8 * sigma_33
                        ...
                        8 * sigma_30) / 4 - delta_v1**3 * (
                            ...
                            * cos(3 * mu0 - 9 * sigma_30)
                            ...
                            exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33 / 2) *
                            cos(mu0 - 3 * sigma_30)) / 4 + 3 * delta_v1**3 * (
...
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} + \frac{3}{4} \,
...
{\Delta v_0}^{3} + \frac{1}{4} \, {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3
...
{\Delta v_1} + \frac{3}{4} \, {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(3 \, \mu_{0} - 9 \,
...
\mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{9}{4} \, {\left(3 \, \sigma_{20}
...
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{1} - 3 \, \sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{9}{4} \,
{\left({\left(\mu_{2} - 3 \, \sigma_{32}\right)} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3}
- \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - 3 \, \sigma_{20} e^{\left(-3 \, \mu_{3} -
\frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)}
{\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \, {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)
...
\frac{1}{4} \, {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} {\Delta v_1}^{3} + \frac{3}{4} \, {\left(3 \, \sigma_{20} \cos\left(3 \, \mu_{0} - 9 \,
...
{\left(\sigma_{22} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) + {\left(2 \, \sigma_{20} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2
\, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} - 2 \,
\sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - 2 \,
\sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} + 3 \, {\left(\sigma_{22} \cos\left(2 \, \mu_{0} - 4 \,
...
\frac{3}{2} \, {\left(\sigma_{22} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \,
...
\mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
{\left(\mu_{2} - 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{2} - {\left({\left(\sigma_{22}
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_0} - 3
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_0} - 3 \,
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_1} + {\left({\left(\sigma_{22}
...
{\left({\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \mu_{2} + \mu_{2} \sigma_{21} + \mu_{1} \sigma_{22}\right)} \mu_{2}
+ {\left(\mu_{2}^{2} + \sigma_{22}\right)} \sigma_{21} + 2 \, {\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \sigma_{22}
"""
