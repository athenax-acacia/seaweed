...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,1,3,1
# to recreate, then copy the file 'moment_0131.py' on top of this one.
...
def moment_0131(delta_v, mu, sigma):
                    ...
                    * sin(mu0 - 3 * sigma_30) +
                    ...
                    (sigma_21 *
                     ...
                     (mu2 + sigma_20 + sigma_32))) + mu3 * (
                         mu2 * (mu1 * sigma_22 + mu2 * sigma_21 + mu2 *
                                (mu1 * mu2 + sigma_21)) + sigma_21 *
                         (mu2**2 + sigma_22) + 2 * sigma_22 *
                         (mu1 * mu2 + sigma_21)) + sigma_31 * (
                             2 * mu2 * sigma_22 + mu2 *
                             (mu2**2 + sigma_22)) + 3 * sigma_32 * (
...
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} + \frac{3}{4} \, {\left(\sigma_{32} \cos\left(3 \,
...
\frac{1}{4} \, {\left(\sigma_{31} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} +
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{3}{4} \, {\left(\sigma_{31}
...
v_1} - \frac{9}{4} \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
- \frac{9}{4} \, {\left(\sigma_{32} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \, {\left(\sigma_{31} e^{\left(-3 \, \mu_{3} -
...
\frac{1}{4} \, {\left(\sigma_{31} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{4} \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \,
...
{\Delta v_0}^{2} + \frac{3}{2} \, {\left({\left(\sigma_{22} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
\sigma_{30}\right)\right)} {\left(\mu_{2} - 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\left(\mu_{3} - 2 \,
\sigma_{30} + 2 \, \sigma_{33}\right)} + 2 \, {\left(2 \, \sigma_{20} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0}^{2} + 3 \, {\left({\left(\sigma_{22} \cos\left(2 \, \mu_{0}
- 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} -
...
2 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
\, \sigma_{33}\right)} - 2 \, \sigma_{20} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0} {\Delta v_1} + 3 \,
...
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{32}\right)} {\Delta v_1}^{2} - \frac{3}{2} \, {\left({\left(\sigma_{22} e^{\left(-2 \, \mu_{3} - 2 \,
\sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) + {\left(2 \, \sigma_{20}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - 2 \, \sigma_{20} + 2 \,
\sigma_{32}\right)}\right)} {\left(\mu_{3} - 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} + 2 \, {\left(2 \, \sigma_{20}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_1}^{2} -
{\left({\left({\left(\sigma_{22} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\left(\mu_{3} +
\sigma_{30} + \sigma_{33}\right)} + 3 \, {\left(\sigma_{22} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{2} - \sigma_{32}\right)}
...
\sigma_{32}\right)} {\Delta v_0} - 3 \, {\left({\left({\left(\sigma_{21} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00}
...
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
\sigma_{21} + {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00}
+ \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{22} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{32}\right)} {\Delta v_0} - 3 \,
...
\sigma_{32}\right)}\right)} \sigma_{32}\right)} {\Delta v_1} + {\left({\left({\left(\sigma_{22} e^{\left(-\mu_{3} -
...
\sigma_{33}\right)} + 3 \, {\left(\sigma_{22} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
\sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{20} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{2} -
\sigma_{32}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)}\right)}
\sigma_{32}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \mu_{2} + \mu_{2}
\sigma_{21} + \mu_{1} \sigma_{22}\right)} \mu_{2} + {\left(\mu_{2}^{2} + \sigma_{22}\right)} \sigma_{21} + 2 \,
{\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \sigma_{22}\right)} \mu_{3} + {\left({\left(\mu_{2}^{2} +
\sigma_{22}\right)} \mu_{2} + 2 \, \mu_{2} \sigma_{22}\right)} \sigma_{31} + 3 \, {\left({\left(\mu_{1} \mu_{2} +
\sigma_{21}\right)} \mu_{2} + \mu_{2} \sigma_{21} + \mu_{1} \sigma_{22}\right)} \sigma_{32}
"""
