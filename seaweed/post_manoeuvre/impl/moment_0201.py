...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,2,0,1
# to recreate, then copy the file 'moment_0201.py' on top of this one.
...
def moment_0201(delta_v, mu, sigma):
        ...
        cos(2 * mu0 - 4 * sigma_30)) / 2 - delta_v0 * delta_v1 * (
            ...
            * sin(2 * mu0 - 4 * sigma_30)) - 2 * delta_v0 * (
                ...
                (-sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                 ...
                 cos(mu0 - sigma_30)) *
                (mu3 + sigma_30 + sigma_33)) + delta_v1**2 * (
                    mu3 - 2 * sigma_33
                    ...
                    * sin(2 * mu0 - 4 * sigma_30) + (mu3 - 2 * sigma_33) *
                    ...
                    (sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                     ...
                     (mu1 - sigma_31) * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2)
                     * sin(mu0 - sigma_30)) *
                    (mu3 - sigma_30 + sigma_33)) + 2 * mu1 * sigma_31 + mu3 * (
                        mu1**2 + sigma_11)


def latex_0201():
    return r"""
\frac{1}{2} \, {\Delta v_0}^{2} {\left(\mu_{3} - 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \frac{1}{2} \, {\Delta v_1}^{2} {\left(\mu_{3} - 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} +
2 \, \sigma_{33}\right)} + \frac{1}{2} \, {\left({\left(\mu_{3} - 2 \, \sigma_{33}\right)} \cos\left(2 \, \mu_{0} - 4 \,
...
{\Delta v_0}^{2} - {\left(2 \, \sigma_{30} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2
...
v_1} - \frac{1}{2} \, {\left({\left(\mu_{3} - 2 \, \sigma_{33}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
{\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)}\right)} {\Delta v_0} + 2 \, {\left(\sigma_{31} e^{\left(-\mu_{3} -
...
\sigma_{33}\right)}\right)} {\Delta v_1} + {\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{3} + 2 \, \mu_{1} \sigma_{31}
"""
