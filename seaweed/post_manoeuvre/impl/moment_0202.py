...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,2,0,2
# to recreate, then copy the file 'moment_0202.py' on top of this one.
...
def moment_0202(delta_v, mu, sigma):
    ...
    return delta_v0**2 * (
        ...
        (mu3 - 2 * sigma_30 + 2 * sigma_33)) - 2 * delta_v0 * (
            ...
            (-2 * sigma_30 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
             ...
             (mu3 - 2 * sigma_33) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33)
             * cos(2 * mu0 - 4 * sigma_30)) *
            (mu3 + 2 * sigma_30 + 2 * sigma_33)) / 2 + 2 * delta_v1 * (
                sigma_31 *
                (sigma_30 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                 cos(mu0 - sigma_30) +
                 (mu3 - sigma_33) * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                ...
                (mu3 - sigma_30 + sigma_33)) + mu3 * (
                    ...
                    (mu1**2 + sigma_11)) + 2 * sigma_31 * (
                        mu1 * mu3 + sigma_31) + sigma_33 * (mu1**2 + sigma_11)


def latex_0202():
    return r"""
\frac{1}{2} \, {\left(\sigma_{33} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \,
\sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{3} - 2 \, \sigma_{33}\right)} \cos\left(2 \, \mu_{0} - 4 \,
...
{\left(\mu_{3} + 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \,
{\left({\left(\mu_{3} + 2 \, \sigma_{33}\right)} {\left(\mu_{3} - 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{33} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} -
{\left(\sigma_{33} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) + {\left(2 \, \sigma_{30} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2
\, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{3} - 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} - 2 \,
\sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{3} - 2 \,
\sigma_{30} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1} - \frac{1}{2} \, {\left(\sigma_{33} \cos\left(2
...
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} + \frac{1}{2} \, {\left({\left(\mu_{3} + 2 \, \sigma_{33}\right)}
{\left(\mu_{3} - 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{33} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 2 \, {\left({\left(\sigma_{31} \cos\left(\mu_{0} -
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_0} + 2 \, {\left({\left(\sigma_{31}
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{31} + {\left(\sigma_{10} \cos\left(\mu_{0}
- \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} +
{\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_1} + {\left({\left(\mu_{1}^{2} +
\sigma_{11}\right)} \mu_{3} + 2 \, \mu_{1} \sigma_{31}\right)} \mu_{3} + 2 \, {\left(\mu_{1} \mu_{3} +
\sigma_{31}\right)} \sigma_{31} + {\left(\mu_{1}^{2} + \sigma_{11}\right)} \sigma_{33}
"""
