...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,2,2,0
# to recreate, then copy the file 'moment_0220.py' on top of this one.
...
def moment_0220(delta_v, mu, sigma):
                        ...
                        * cos(2 * mu0 - 4 * sigma_30) +
                        ...
                        -4 * mu3 - 8 * sigma_00 + 8 * sigma_33) * sin(
                            ...
                            * sin(3 * mu0 - 9 * sigma_30)
                            ...
                            -4 * mu3 + 8 * sigma_33) / 8 - delta_v1**4 * exp(
                                -4 * mu3 - 8 * sigma_00 + 8 * sigma_33) * cos(
                                    4 * mu0 - 16 * sigma_30
                                ) / 8 + delta_v1**3 * (
                                    3 * sigma_10
                                    * exp(-3 * mu3 - 9 * sigma_00 / 2 + 9 *
                                          sigma_33 / 2) *
                                    cos(3 * mu0 - 9 * sigma_30) +
                                    (mu1 - 3 * sigma_31) *
                                    exp(-3 * mu3 - 9 * sigma_00 / 2 + 9 *
                                    ...
                                    * cos(2 * mu0 - 4 * sigma_30) +
                                    ...
                                    (mu2 - sigma_20 + sigma_32)) + mu2 * (
                                        ...
                                        (mu1**2 + sigma_11)) + 2 * sigma_21 * (
                                            mu1 * mu2 + sigma_21
                                        ) + sigma_22 * (mu1**2 + sigma_11)


def latex_0220():
    return r"""
-\frac{1}{8} \, {\Delta v_0}^{4} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} + \frac{3}{4} \, {\Delta v_0}^{2} {\Delta v_1}^{2} \cos\left(4 \, \mu_{0} - 16 \,
\sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - \frac{1}{8} \, {\Delta
v_1}^{4} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} + \frac{1}{2} \, {\Delta v_0}^{3} {\Delta v_1} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) - \frac{1}{2} \, {\Delta v_0} {\Delta v_1}^{3}
e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) +
\frac{1}{8} \, {\Delta v_0}^{4} e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} + \frac{1}{4} \, {\Delta v_0}^{2}
{\Delta v_1}^{2} e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} + \frac{1}{8} \, {\Delta v_1}^{4} e^{\left(-4 \,
\mu_{3} + 8 \, \sigma_{33}\right)} - \frac{1}{2} \, {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(\mu_{0} -
...
3 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} - \frac{1}{2} \, {\left(\sigma_{20} \cos\left(\mu_{0} - 3 \,
...
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} + \frac{1}{2} \,
...
{\Delta v_0}^{3} - \frac{1}{2} \, {\left(3 \, \sigma_{20} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3
\, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} + {\left(\mu_{2} - 3 \, \sigma_{32}\right)}
e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \,
\sigma_{30}\right)\right)} {\Delta v_0}^{3} - \frac{1}{2} \, {\left({\left(\mu_{2} - 3 \, \sigma_{32}\right)}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} - \sigma_{20} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{1}{2} \,
...
{\Delta v_1} - \frac{3}{2} \, {\left({\left(\mu_{2} - 3 \, \sigma_{32}\right)} \cos\left(3 \, \mu_{0} - 9 \,
...
\mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{3}{2} \, {\left(3 \, \sigma_{10}
...
\frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta
v_1} - \frac{1}{2} \, {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{1}{2} \, {\left(\sigma_{20} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{2} - 3 \, \sigma_{32}\right)} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{2} \,
{\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3}
- \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - 3 \, \sigma_{10} e^{\left(-3 \, \mu_{3} -
\frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)}
{\Delta v_0} {\Delta v_1}^{2} + \frac{3}{2} \, {\left(3 \, \sigma_{20} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)
e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} + {\left(\mu_{2} - 3 \,
\sigma_{32}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3
\, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{1}{2} \, {\left({\left(\mu_{2} - 3 \,
\sigma_{32}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} - \sigma_{20} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_1}^{3} + \frac{1}{2} \,
{\left(\sigma_{10} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - 3 \, \sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_1}^{3} +
\frac{1}{2} \, {\left({\left(\mu_{2} - 3 \, \sigma_{32}\right)} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} {\Delta v_1}^{3} + \frac{1}{2} \, {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \,
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_1}^{3} - \frac{1}{2} \,
{\left(\sigma_{11} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
\sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \, {\left(\sigma_{22} \cos\left(2 \,
...
\sigma_{32}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \, {\left({\left(\mu_{1} + 2 \, \sigma_{31}\right)}
{\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{11} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \, {\left({\left(\mu_{2} + 2 \,
\sigma_{32}\right)} {\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + 2 \, {\left(\sigma_{21}
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - 2 \, \sigma_{20} + 2 \,
\sigma_{32}\right)}\right)} {\Delta v_0}^{2} + 4 \, {\left(\sigma_{21} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)}
...
v_1} + {\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} -
...
2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\Delta v_0} {\Delta v_1} - {\left(\sigma_{22} e^{\left(-2 \,
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - 2 \, \sigma_{20} + 2 \,
\sigma_{32}\right)}\right)} {\Delta v_0} {\Delta v_1} + \frac{1}{2} \, {\left(\sigma_{11} \cos\left(2 \, \mu_{0} - 4 \,
...
{\Delta v_1}^{2} - \frac{1}{2} \, {\left(\sigma_{22} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \,
...
\sigma_{30}\right)\right)} {\left(\mu_{2} + 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{2} +
\frac{1}{2} \, {\left({\left(\mu_{1} + 2 \, \sigma_{31}\right)} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{11} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta
v_1}^{2} + \frac{1}{2} \, {\left({\left(\mu_{2} + 2 \, \sigma_{32}\right)} {\left(\mu_{2} - 2 \, \sigma_{32}\right)}
e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 2 \, {\left(\sigma_{21} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
\sigma_{30}\right)\right)} {\left(\mu_{2} - 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{2} - 2 \,
{\left({\left(\sigma_{21} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_0} - 2 \, {\left({\left(\sigma_{11}
...
\sigma_{10} + \sigma_{31}\right)}\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)} + 2 \, {\left(\sigma_{10}
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_0} - 2 \,
{\left({\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{1} - \sigma_{31}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_1} + 2
\, {\left({\left(\sigma_{21} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
...
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
\sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_1} +
{\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{2} + 2 \, \mu_{1} \sigma_{21}\right)} \mu_{2} + 2 \, {\left(\mu_{1}
\mu_{2} + \sigma_{21}\right)} \sigma_{21} + {\left(\mu_{1}^{2} + \sigma_{11}\right)} \sigma_{22}
"""
