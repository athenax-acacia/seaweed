...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,3,0,0
# to recreate, then copy the file 'moment_0300.py' on top of this one.
...
def moment_0300(delta_v, mu, sigma):
    ...
    return -delta_v0**3 * exp(
    ...
    ) * cos(3 * mu0 - 9 * sigma_30) / 4 - 3 * delta_v0**3 * exp(
        ...
        -3 * mu3 - 9 * sigma_00 / 2 + 9 * sigma_33 / 2) * sin(
            3 * mu0 - 9 * sigma_30) / 4 + 3 * delta_v0**2 * delta_v1 * exp(
                ...
                2) * sin(mu0 - 3 * sigma_30) / 4 + 3 * delta_v0**2 * (
                    mu1 - 2 * sigma_31
                    ...
                    * sin(2 * mu0 - 4 * sigma_30) + (mu1 - 2 * sigma_31) *
                    ...
                    -3 * mu3 - 9 * sigma_00 / 2 + 9 * sigma_33 / 2) * cos(
                        ...
                        -3 * mu3 - sigma_00 / 2 + 9 * sigma_33 / 2) * cos(
                            mu0 - 3 * sigma_30
                            ...
                            * cos(mu0 - sigma_30) +
                            (-sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 /
                             ...
                             cos(mu0 - sigma_30)) *
                            (mu1 + sigma_10 + sigma_31)) - delta_v1**3 * exp(
                                -3 * mu3 - 9 * sigma_00 / 2 +
                                9 * sigma_33 / 2) * sin(
                                    3 * mu0 - 9 * sigma_30
                                ) / 4 + 3 * delta_v1**3 * exp(
                                ...
                                ) + 2 * mu1 * sigma_11 + mu1 * (mu1**2 +
                                                                sigma_11)


def latex_0300():
    return r"""
-\frac{3}{4} \, {\Delta v_0}^{3} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \frac{3}{4} \, {\Delta v_0} {\Delta v_1}^{2} \cos\left(\mu_{0} - 3 \,
...
\sigma_{30}\right) + \frac{3}{4} \, {\Delta v_0}^{2} {\Delta v_1} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right) + \frac{3}{4} \, {\Delta v_1}^{3}
e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \,
\sigma_{30}\right) + \frac{3}{2} \, {\Delta v_0}^{2} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} +
2 \, \sigma_{33}\right)} + \frac{3}{2} \, {\Delta v_1}^{2} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)} + \frac{3}{2} \, {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \cos\left(2 \,
...
\sigma_{30}\right)\right)} {\Delta v_0}^{2} - 3 \, {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1} - \frac{3}{2} \, {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)}
...
\sigma_{30}\right)\right)} {\Delta v_1}^{2} - 3 \, {\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right)
...
3 \, {\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
...
{\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)} {\Delta v_1} + {\left(\mu_{1}^{2} + \sigma_{11}\right)}
\mu_{1} + 2 \, \mu_{1} \sigma_{11}
"""
