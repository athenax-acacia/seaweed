...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,3,0,2
# to recreate, then copy the file 'moment_0302.py' on top of this one.
...
def moment_0302(delta_v, mu, sigma):
        ...
        (mu3 - 2 * sigma_30 + 2 * sigma_33)) - 3 * delta_v0 * (
            ...
            (mu3 + 2 * sigma_30 + 2 * sigma_33)) / 2 + 3 * delta_v1**2 * (
                ...
                (mu3 - sigma_30 + sigma_33)) + mu3 * (
                    ...
                    (mu1**2 + sigma_11)) + 3 * sigma_31 * (
                        2 * mu1 * sigma_31 + mu3 *
                        (mu1**2 + sigma_11)) + sigma_33 * (2 * mu1 * sigma_11 +
                                                           mu1 *
                                                           (mu1**2 + sigma_11))
...
def latex_0302():
    return r"""
-\frac{3}{4} \, {\left(\sigma_{33} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
- 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{3}{4} \, {\left(\sigma_{33}
...
\frac{3}{2} \, {\left({\left(\mu_{3} - 2 \, \sigma_{33}\right)} \sigma_{31} e^{\left(-2 \, \mu_{3} + 2 \,
...
{\left({\left(\mu_{3} - 2 \, \sigma_{33}\right)} \sigma_{31} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{1} - 2 \, \sigma_{31}\right)} \sigma_{33} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} {\left(\mu_{3} + 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{31} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} - \frac{3}{2} \, {\left({\left(\sigma_{31} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{33}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left({\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\sigma_{31}\right)}\right)} \sigma_{33}\right)} {\Delta v_0} + 3 \, {\left({\left({\left(\sigma_{11} e^{\left(-\mu_{3} -
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{31}\right)} {\left(\mu_{3} - \sigma_{30} +
\sigma_{33}\right)} + 2 \, {\left(\sigma_{31} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{33}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{1}^{2} +
\sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)} \mu_{3} + 3 \, {\left(\mu_{1}^{2} + \sigma_{11}\right)}
\sigma_{31}\right)} \mu_{3} + 3 \, {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{3} + 2 \, \mu_{1}
\sigma_{31}\right)} \sigma_{31} + {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1}
\sigma_{11}\right)} \sigma_{33}
"""
