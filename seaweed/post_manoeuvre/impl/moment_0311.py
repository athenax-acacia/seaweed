...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,3,1,1
# to recreate, then copy the file 'moment_0311.py' on top of this one.
...
def moment_0311(delta_v, mu, sigma):
    ...
    return delta_v0**4 * (
        ...
        sin(4 * mu0 - 16 * sigma_30)) / 8 + delta_v0**4 * (
            2 * sigma_30 * exp(-4 * mu3 - 2 * sigma_00 + 8 * sigma_33) *
            cos(2 * mu0 - 8 * sigma_30) +
            (mu3 - 4 * sigma_33) * exp(-4 * mu3 - 2 * sigma_00 + 8 * sigma_33)
            ...
            * sin(4 * mu0 - 16 * sigma_30)
            ...
            (sigma_20 * exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33 / 2) *
             ...
             (mu2 - 3 * sigma_32) * exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33
                                        / 2) * sin(mu0 - 3 * sigma_30)) *
            (mu3 - sigma_30 + 3 * sigma_33)) / 4 + 3 * delta_v0**2 * (
                2 * sigma_31 *
                ...
                -2 * sigma_30 * exp(-4 * mu3 - 2 * sigma_00 + 8 * sigma_33) *
                sin(2 * mu0 - 8 * sigma_30) + (mu3 - 4 * sigma_33) *
                ...
                * sin(3 * mu0 - 9 * sigma_30) +
                ...
                sin(mu0 - 3 * sigma_30) +
                (sigma_10 * exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33 / 2) *
                 cos(mu0 - 3 * sigma_30) + (mu1 - 3 * sigma_31) *
                ...
                * cos(3 * mu0 - 9 * sigma_30) +
                ...
                sin(4 * mu0 - 16 * sigma_30)) / 8 - delta_v1**4 * (
                    2 * sigma_30 * exp(-4 * mu3 - 2 * sigma_00 + 8 * sigma_33)
                    * cos(2 * mu0 - 8 * sigma_30) + (mu3 - 4 * sigma_33) *
                    exp(-4 * mu3 - 2 * sigma_00 + 8 * sigma_33) *
                    sin(2 * mu0 - 8 * sigma_30)
                ) / 4 + 3 * delta_v1**3 * (
                    ...
                    * sin(mu0 - 3 * sigma_30) +
                    ...
                    (mu3 - sigma_30 + sigma_33)) + mu3 * (
                        mu2 * (2 * mu1 * sigma_11 + mu1 *
                               (mu1**2 + sigma_11)) + 3 * sigma_21 *
                        (mu1**2 + sigma_11)) + 3 * sigma_31 * (
                            2 * mu1 * sigma_21 + mu2 *
                            (mu1**2 + sigma_11)) + sigma_32 * (
                                2 * mu1 * sigma_11 + mu1 * (mu1**2 + sigma_11))


def latex_0311():
    return r"""
\frac{1}{4} \, {\left(2 \, \sigma_{30} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{3} - 4 \, \sigma_{33}\right)} e^{\left(-4 \, \mu_{3} - 2 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} +
\frac{1}{8} \, {\left(4 \, \sigma_{30} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{3} - 4 \, \sigma_{33}\right)} e^{\left(-4 \, \mu_{3} - 8 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} +
\frac{1}{2} \, {\left({\left(\mu_{3} - 4 \, \sigma_{33}\right)} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)
e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 2 \, \sigma_{30} e^{\left(-4 \, \mu_{3} - 2 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta
v_1} + \frac{1}{2} \, {\left({\left(\mu_{3} - 4 \, \sigma_{33}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)
e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 4 \, \sigma_{30} e^{\left(-4 \, \mu_{3} - 8 \,
\sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3}
{\Delta v_1} - \frac{3}{4} \, {\left(4 \, \sigma_{30} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \,
\mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{3} - 4 \, \sigma_{33}\right)} e^{\left(-4 \, \mu_{3}
- 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2}
{\Delta v_1}^{2} + \frac{1}{2} \, {\left({\left(\mu_{3} - 4 \, \sigma_{33}\right)} \cos\left(2 \, \mu_{0} - 8 \,
\sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 2 \, \sigma_{30} e^{\left(-4
\, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)}
{\Delta v_0} {\Delta v_1}^{3} - \frac{1}{2} \, {\left({\left(\mu_{3} - 4 \, \sigma_{33}\right)} \cos\left(4 \, \mu_{0} -
16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 4 \, \sigma_{30}
e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \,
\sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{3} - \frac{1}{4} \, {\left(2 \, \sigma_{30} \cos\left(2 \, \mu_{0}
- 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{3} - 4 \,
\sigma_{33}\right)} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \,
\sigma_{30}\right)\right)} {\Delta v_1}^{4} + \frac{1}{8} \, {\left(4 \, \sigma_{30} \cos\left(4 \, \mu_{0} - 16 \,
\sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{3} - 4 \,
\sigma_{33}\right)} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \,
\sigma_{30}\right)\right)} {\Delta v_1}^{4} - \frac{3}{4} \, {\left(\sigma_{32} \cos\left(\mu_{0} - 3 \,
...
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{1}{4} \, {\left(\sigma_{32} \cos\left(3 \,
...
\sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} -
\frac{3}{4} \, {\left(\sigma_{31} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{4} \, {\left(\sigma_{31} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
\frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} - \sigma_{30} + 3
\, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{4} \, {\left(\sigma_{31} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} +
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{9}{4} \, {\left(\sigma_{31}
...
v_1} + \frac{3}{4} \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} - 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{3}{4} \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} -
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} -
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{3}{4} \, {\left(\sigma_{32}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
...
+ \frac{3}{4} \, {\left(\sigma_{32} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} + \frac{9}{4} \, {\left(\sigma_{31} e^{\left(-3 \, \mu_{3} -
\frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) +
{\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \,
...
{\left(\mu_{3} - 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \,
{\left(\sigma_{31} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)}
...
\sigma_{30}\right)\right)} {\left(\mu_{3} - \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2}
- \frac{3}{4} \, {\left(\sigma_{31} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(\mu_{0} -
...
\frac{3}{4} \, {\left(\sigma_{31} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{3} - \frac{1}{4} \, {\left(\sigma_{32} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \,
...
- 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{4} \, {\left(\sigma_{32} e^{\left(-3
\, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)
+ {\left(\sigma_{20} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} + {\left(\mu_{2} - 3 \, \sigma_{32}\right)} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} -
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{2} \, {\left({\left(\mu_{2} - 2 \,
\sigma_{32}\right)} \sigma_{31} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \,
\sigma_{31}\right)} \sigma_{32} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \,
\sigma_{31}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{21} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \, \sigma_{33}\right)}\right)}
{\Delta v_0}^{2} + \frac{3}{2} \, {\left({\left(\sigma_{21} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2
...
\sigma_{30}\right)\right)} {\left(\mu_{2} + 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\left(\mu_{3} + 2 \,
\sigma_{30} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{31} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \,
\sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)}
{\Delta v_0}^{2} + \frac{3}{2} \, {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
\sigma_{30}\right)\right)} {\left(\mu_{1} - 2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\left(\mu_{3} - 2 \,
\sigma_{30} + 2 \, \sigma_{33}\right)} + 2 \, {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_0}^{2} + 3 \, {\left({\left(\sigma_{11} \cos\left(2 \, \mu_{0}
...
\sigma_{31}\right)}\right)} {\left(\mu_{3} + 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} + 2 \, {\left({\left(\mu_{1} -
2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
\, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_0} {\Delta v_1} - 3 \,
...
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0} {\Delta v_1} + \frac{3}{2} \,
{\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \sigma_{31} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{1} - 2 \, \sigma_{31}\right)} \sigma_{32} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{21} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} - \frac{3}{2} \, {\left({\left(\sigma_{21} \cos\left(2 \, \mu_{0} - 4 \,
...
{\left(\mu_{3} + 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} -
2 \, \sigma_{20} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{31} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{32}\right)} {\Delta v_1}^{2} - \frac{3}{2} \, {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \,
...
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_1}^{2} - 3 \,
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{32}\right)} {\Delta v_0} -
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{11}\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)} + 3 \, {\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
...
\sigma_{31}\right)} {\Delta v_0} - {\left({\left({\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\sigma_{30}\right)\right)} \sigma_{11}\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} + 3 \,
{\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} + {\left({\left(\mu_{1} - \sigma_{31}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{31}\right)} {\Delta v_1} + 3 \,
{\left({\left({\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
...
\, \sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{21}\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{21} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{10} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{1}
- \sigma_{31}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{31} +
...
\sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{32}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{1}^{2} +
\sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)} \mu_{2} + 3 \, {\left(\mu_{1}^{2} + \sigma_{11}\right)}
\sigma_{21}\right)} \mu_{3} + 3 \, {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{2} + 2 \, \mu_{1}
\sigma_{21}\right)} \sigma_{31} + {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1}
\sigma_{11}\right)} \sigma_{32}
"""
