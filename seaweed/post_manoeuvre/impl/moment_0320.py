...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,3,2,0
# to recreate, then copy the file 'moment_0320.py' on top of this one.
...
def moment_0320(delta_v, mu, sigma):
    ...
    return delta_v0**5 * exp(
    ...
    ) * cos(5 * mu0 - 25 * sigma_30) / 16 + delta_v0**5 * exp(
        ...
        * (mu2 + sigma_20 + 3 * sigma_32)
         ...
         * (mu1 - 2 * sigma_10 + 2 * sigma_31))
        * (mu1 - 2 * sigma_10 + 2 * sigma_31)
    ) + 6 * delta_v0 * delta_v1 * (2 * sigma_21 * (
        -2 * sigma_10 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33)
        * sin(2 * mu0 - 4 * sigma_30)
        +
        (mu1 - 2 * sigma_31) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33)
        * cos(2 * mu0 - 4 * sigma_30)
    ) + (sigma_11 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) * cos(
        2 * mu0 - 4 * sigma_30) +
         (-2 * sigma_10 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          sin(2 * mu0 - 4 * sigma_30)
          + (mu1 - 2 * sigma_31) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33)
         ...
         * (mu1 + 2 * sigma_10 + 2 * sigma_31)
             ...
             mu2 + 2 * sigma_20 +
             2 * sigma_32)) - 3 * delta_v0 * delta_v1 * (
                 sigma_21 *
                 (2 * sigma_20 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
                  cos(2 * mu0 - 4 * sigma_30)
                  + (mu2 - 2 * sigma_32)
                 ...
                 * (mu2 - sigma_20 + sigma_32)
                 ...
                 -5 * mu3 - 25 * sigma_00 / 2 + 25 * sigma_33 / 2) * sin(
                     5 * mu0 - 25 * sigma_30) / 16 + delta_v1**5 * exp(
                         -5 * mu3 - 9 * sigma_00 / 2 + 25 * sigma_33 / 2
                     ) * sin(3 * mu0 - 15 * sigma_30) / 16 + delta_v1**5 * exp(
                         -5 * mu3 - sigma_00 / 2 + 25 * sigma_33 / 2) * sin(
                             mu0 - 5 * sigma_30
                         ) / 8 + 3 * delta_v1**4 * (mu1 - 4 * sigma_31) * exp(
                             -4 * mu3 + 8 * sigma_33) / 8 - 3 * delta_v1**4 * (
                                 -4 * sigma_10 *
                                 exp(-4 * mu3 - 8 * sigma_00 + 8 * sigma_33) *
                                 sin(4 * mu0 - 16 * sigma_30) +
                                 (mu1 - 4 * sigma_31) *
                                 ...
                                 (mu2 - sigma_20 + sigma_32)) + mu2 * (
                                     mu2 *
                                     (2 * mu1 * sigma_11 + mu1 *
                                      (mu1**2 + sigma_11)) + 3 * sigma_21 *
                                     (mu1**2 + sigma_11)) + 3 * sigma_21 * (
                                         2 * mu1 * sigma_21 + mu2 *
                                         (mu1**2 + sigma_11)) + sigma_22 * (
                                             2 * mu1 * sigma_11 + mu1 *
                                             (mu1**2 + sigma_11))
...
\frac{1}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} + \frac{1}{16} \, {\Delta v_0}^{5} \cos\left(3 \,
\mu_{0} - 15 \, \sigma_{30}\right) e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \,
\sigma_{33}\right)} - \frac{1}{8} \, {\Delta v_0}^{3} {\Delta v_1}^{2} \cos\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right)
e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} - \frac{3}{16} \, {\Delta v_0}
...
\frac{25}{2} \, \sigma_{33}\right)} \sin\left(5 \, \mu_{0} - 25 \, \sigma_{30}\right) - \frac{3}{16} \, {\Delta v_0}^{4}
{\Delta v_1} e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} \sin\left(3 \,
\mu_{0} - 15 \, \sigma_{30}\right) - \frac{1}{8} \, {\Delta v_0}^{2} {\Delta v_1}^{3} e^{\left(-5 \, \mu_{3} -
\frac{9}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right) +
\frac{1}{16} \, {\Delta v_1}^{5} e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \,
...
\sigma_{31}\right)} e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} + \frac{1}{2} \, {\left(2 \, \sigma_{20}
\cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} +
{\left(\mu_{2} - 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} - \frac{3}{8} \, {\left({\left(\mu_{1} - 4 \,
...
\, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + \frac{1}{4} \, {\left(4 \, \sigma_{20} \cos\left(4 \,
\mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{2}
- 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} -
16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + {\left({\left(\mu_{2} - 4 \, \sigma_{32}\right)} \cos\left(2 \,
...
\sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} + {\left({\left(\mu_{2} - 4 \, \sigma_{32}\right)} \cos\left(4
\, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 4 \,
\sigma_{20} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \,
\sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} + \frac{3}{2} \, {\left(4 \, \sigma_{10} \cos\left(4 \, \mu_{0}
...
\sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} + \frac{9}{4} \, {\left({\left(\mu_{1} - 4 \,
\sigma_{31}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} - 4 \, \sigma_{10} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4
\, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1}^{2} - \frac{3}{2} \, {\left(4 \, \sigma_{20}
...
\sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1}^{2} + {\left({\left(\mu_{2} - 4
\, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} - 2 \, \sigma_{20} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2
\, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{3} - {\left({\left(\mu_{2} - 4 \,
\sigma_{32}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} - 4 \, \sigma_{20} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4
\, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{3} - \frac{3}{2} \, {\left(4 \, \sigma_{10}
\cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} +
{\left(\mu_{1} - 4 \, \sigma_{31}\right)} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)}
\sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{3} - \frac{1}{2} \, {\left(2 \,
\sigma_{20} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} + {\left(\mu_{2} - 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_1}^{4} - \frac{3}{8} \,
...
\, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_1}^{4} + \frac{1}{4} \,
...
\sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_1}^{4} - \frac{3}{4} \,
{\left(\sigma_{11} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
\frac{3}{4} \, {\left(\sigma_{22} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
\frac{3}{4} \, {\left(\sigma_{11} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
\sigma_{31}\right)}\right)} {\Delta v_0}^{3} - \frac{1}{4} \, {\left(\sigma_{22} \cos\left(3 \, \mu_{0} - 9 \,
...
{\left(\mu_{2} + 3 \, \sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{2} \,
...
{\Delta v_0}^{3} - \frac{3}{2} \, {\left(\sigma_{21} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right) + {\left(\sigma_{10} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
...
\sigma_{32}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{2} \, {\left(\sigma_{21} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
...
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{9}{2} \, {\left(\sigma_{21}
...
v_1} - \frac{9}{4} \, {\left(\sigma_{11} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{1} - 3 \, \sigma_{10} + 3 \,
\sigma_{31}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{3}{4} \, {\left(\sigma_{22} e^{\left(-3 \, \mu_{3} -
...
\frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)}
{\left(\mu_{2} - 3 \, \sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{3}{4} \,
...
\sigma_{30}\right)\right)} {\left(\mu_{1} - \sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1}
...
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + 3 \,
\sigma_{32}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{3}{4} \, {\left(\sigma_{11} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{1} +
\sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \, {\left(\sigma_{22}
...
- \frac{9}{4} \, {\left(\sigma_{11} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
\frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)}
\cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} - 3 \, \sigma_{10} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{1} + 3 \, \sigma_{10} + 3 \,
\sigma_{31}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} + \frac{3}{4} \, {\left(\sigma_{22} \cos\left(3 \, \mu_{0} - 9
\, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{2} - 3 \, \sigma_{32}\right)} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3}
- \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - 3 \, \sigma_{20} e^{\left(-3 \, \mu_{3} -
\frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)}
{\left(\mu_{2} + 3 \, \sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} + \frac{9}{2} \,
{\left(\sigma_{21} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3
\, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)
e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - 3 \,
\sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3
\, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - 3 \, \sigma_{20} + 3 \, \sigma_{32}\right)}\right)}
{\Delta v_0} {\Delta v_1}^{2} - \frac{3}{2} \, {\left(\sigma_{21} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right) + {\left(\sigma_{10} \cos\left(\mu_{0} -
3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{1} - 3 \, \sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + 3 \,
\sigma_{32}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{2} \, {\left(\sigma_{21} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} +
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{2} \, {\left(\sigma_{21} \cos\left(3 \,
\mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} + {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)
e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - 3 \, \sigma_{10} e^{\left(-3
\, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \,
\sigma_{30}\right)\right)} {\left(\mu_{2} + 3 \, \sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{3} +
\frac{3}{4} \, {\left(\sigma_{11} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} -
9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{1} - 3 \, \sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{1} - 3 \, \sigma_{10} + 3 \,
\sigma_{31}\right)}\right)} {\Delta v_1}^{3} - \frac{1}{4} \, {\left(\sigma_{22} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \,
...
- 3 \, \sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{4} \, {\left(\sigma_{11} e^{\left(-3
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{1} -
\sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{4} \, {\left(\sigma_{22} e^{\left(-3 \,
\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right) +
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} -
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{3} + \frac{1}{2} \, {\left(2 \, {\left(\mu_{1} - 2 \,
...
{\Delta v_0}^{2} + \frac{3}{2} \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \sigma_{21} e^{\left(-2 \, \mu_{3} +
2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \, \sigma_{31}\right)} \sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)}
e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{21} e^{\left(-2 \, \mu_{3} + 2 \,
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{11}\right)} {\Delta v_0}^{2} + \frac{3}{2} \, {\left({\left(\sigma_{21} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right)\right)} \sigma_{21} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{22}\right)} {\Delta v_0}^{2} + 3 \, {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
\sigma_{20} + 2 \, \sigma_{32}\right)} + 2 \, {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_0}^{2} + {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2
\, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) + {\left(2 \, \sigma_{10}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{1} - 2 \, \sigma_{10} + 2 \,
\sigma_{31}\right)}\right)} {\left(\mu_{1} - 2 \, \sigma_{10} + 2 \, \sigma_{31}\right)} + 2 \, {\left(2 \, \sigma_{10}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{11}\right)} {\Delta v_0} {\Delta v_1} + 6 \,
{\left({\left(\sigma_{11} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
\, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{21}\right)} {\Delta v_0} {\Delta v_1} - 3 \, {\left({\left(\sigma_{21} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00}
...
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \, \sigma_{31}\right)}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_0} {\Delta v_1} + \frac{1}{2} \, {\left(2 \, {\left(\mu_{1} - 2
\, \sigma_{31}\right)} \sigma_{11} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{1} + 2 \,
\sigma_{31}\right)} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{11} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{1} + 2 \, \sigma_{31}\right)}\right)}
{\Delta v_1}^{2} + \frac{3}{2} \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \sigma_{21} e^{\left(-2 \, \mu_{3} +
2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \, \sigma_{31}\right)} \sigma_{22} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)}
e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{21} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{2} + \frac{1}{2} \,
{\left({\left(\sigma_{11} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
\, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{11}\right)} {\Delta v_1}^{2} - \frac{3}{2} \, {\left({\left(\sigma_{21} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \,
\sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
\sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2
\, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{2} + 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)}
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{22}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) + {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} -
4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \,
\sigma_{31}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} {\left(\mu_{1} - 2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\left(\mu_{2} - 2 \,
...
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \, \sigma_{31}\right)}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left({\left(\sigma_{11}
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{22}\right)} {\Delta v_0} - 2 \,
{\left({\left({\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
...
\sigma_{20} + \sigma_{32}\right)} + 3 \, {\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{10} \cos\left(\mu_{0} -
...
\sigma_{21}\right)} {\Delta v_0} - 2 \, {\left({\left({\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right)
...
+ \sigma_{10} + \sigma_{31}\right)} + 2 \, {\left({\left(\mu_{1} - \sigma_{31}\right)} \cos\left(\mu_{0} -
...
\sigma_{30}\right)\right)} \sigma_{11}\right)} {\left(\mu_{2} + \sigma_{20} + \sigma_{32}\right)} + 3 \,
{\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} + {\left({\left(\mu_{1} - \sigma_{31}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{21}\right)} {\Delta v_1} + 3 \,
{\left({\left({\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
...
\, \sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{21}\right)} {\left(\mu_{2} -
\sigma_{20} + \sigma_{32}\right)} + 2 \, {\left(\sigma_{21} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{10} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{1}
- \sigma_{31}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{21} +
...
\sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{22}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{1}^{2} +
\sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)} \mu_{2} + 3 \, {\left(\mu_{1}^{2} + \sigma_{11}\right)}
\sigma_{21}\right)} \mu_{2} + 3 \, {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{2} + 2 \, \mu_{1}
\sigma_{21}\right)} \sigma_{21} + {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1}
\sigma_{11}\right)} \sigma_{22}
"""
