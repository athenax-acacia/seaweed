...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,4,0,0
# to recreate, then copy the file 'moment_0400.py' on top of this one.
...
def moment_0400(delta_v, mu, sigma):
                    ...
                    sigma_33) * sin(2 * mu0 - 8 * sigma_30) - delta_v0**3 * (
                        ...
                        * cos(2 * mu0 - 4 * sigma_30)
                        ...
                        (mu1 - sigma_10 + sigma_31)) + mu1 * (
                            2 * mu1 * sigma_11 + mu1 *
                            (mu1**2 + sigma_11)) + 3 * sigma_11 * (mu1**2 +
                                                                   sigma_11)
...
{\Delta v_1}^{4} e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} - 3 \, {\left({\left(\mu_{1} - 3 \,
...
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} - {\left({\left(\mu_{1} - 3 \,
\sigma_{31}\right)} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00}
+ \frac{9}{2} \, \sigma_{33}\right)} - 3 \, \sigma_{10} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} +
...
{\Delta v_1} + 3 \, {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
...
\sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1} - 3 \, {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)}
...
\sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{2} + 3 \,
...
{\Delta v_0} {\Delta v_1}^{2} + 3 \, {\left(\sigma_{10} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \,
...
\sigma_{30}\right)\right)} {\Delta v_1}^{3} - {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)
...
\, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_1}^{3} + 3 \, {\left(\sigma_{11} \cos\left(2 \, \mu_{0} - 4 \,
...
{\Delta v_0}^{2} + 3 \, {\left({\left(\mu_{1} + 2 \, \sigma_{31}\right)} {\left(\mu_{1} - 2 \, \sigma_{31}\right)}
e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{11} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_0}^{2} - 6 \, {\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
v_1} - 3 \, {\left(\sigma_{11} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \,
...
{\left(\mu_{1} + 2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\Delta v_1}^{2} + 3 \, {\left({\left(\mu_{1} + 2
\, \sigma_{31}\right)} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{11} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 4 \, {\left({\left(\sigma_{11}
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{11}\right)} {\Delta v_0} + 4
...
{\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)} \mu_{1} + 3 \,
{\left(\mu_{1}^{2} + \sigma_{11}\right)} \sigma_{11}
"""
