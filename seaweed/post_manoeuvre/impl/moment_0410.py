...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 0,4,1,0
# to recreate, then copy the file 'moment_0410.py' on top of this one.
...
def moment_0410(delta_v, mu, sigma):
    ...
    return -delta_v0**5 * exp(
    ...
    ) * sin(5 * mu0 - 25 * sigma_30) / 16 - 3 * delta_v0**5 * exp(
        -5 * mu3 - 9 * sigma_00 / 2 + 25 * sigma_33 / 2
    ) * sin(3 * mu0 - 15 * sigma_30) / 16 - delta_v0**5 * exp(
        ...
        * (mu2 + sigma_20 + 3 * sigma_32)
        ...
        -4 * mu3 + 8 * sigma_33) / 4 - 3 * delta_v0**2 * delta_v1**2 * (
            4 * sigma_10 * exp(-4 * mu3 - 8 * sigma_00 + 8 * sigma_33)
            * cos(4 * mu0 - 16 * sigma_30)
            + (mu1 - 4 * sigma_31)
            * exp(-4 * mu3 - 8 * sigma_00 + 8 * sigma_33)
            * sin(4 * mu0 - 16 * sigma_30)
        ) - 3 * delta_v0**2 * delta_v1**2 * (
            -4 * sigma_20 *
            exp(-4 * mu3 - 8 * sigma_00 + 8 * sigma_33)
            * sin(4 * mu0 - 16 * sigma_30)
            + (mu2 - 4 * sigma_32)
                                ...
                                * cos(mu0 - 3 * sigma_30) +
                                ...
                                (2 * sigma_11 *
                                 ...
                                 (sigma_11 * exp(-mu3 - sigma_00 / 2 + sigma_33
                                  ...
                                  (mu1 - sigma_10 + sigma_31)) *
                                 (mu1 - sigma_10 + sigma_31)) *
                                (mu1 - sigma_10 + sigma_31)) - 4 * delta_v0 * (
                                    3 * sigma_21 *
                                    (sigma_11 *
                                     exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                                     cos(mu0 - sigma_30) +
                                    ...
                                    25 * sigma_33 / 2) * cos(
                                        ...
                                        25 * sigma_33 / 2) * cos(
                                            ...
                                            25 * sigma_33 / 2) * cos(
                                                ...
                                                cos(4 * mu0 - 16 * sigma_30) +
                                                (mu1 - 4 * sigma_31) *
                                                exp(-4 * mu3 - 8 * sigma_00 +
                                                    8 * sigma_33) *
                                                sin(4 * mu0 - 16 * sigma_30)
                                            ) / 2 - delta_v1**4 * (
                                                2 * sigma_10 *
                                                exp(-4 * mu3 - 2 * sigma_00 +
                                                    8 * sigma_33) *
                                                cos(2 * mu0 - 8 * sigma_30) +
                                                (mu1 - 4 * sigma_31) *
                                                exp(-4 * mu3 - 2 * sigma_00 +
...
- \frac{1}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} - \frac{9}{16} \, {\Delta v_0}^{4} {\Delta v_1}
\cos\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right) e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \,
\sigma_{33}\right)} - \frac{3}{8} \, {\Delta v_0}^{2} {\Delta v_1}^{3} \cos\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right)
e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} + \frac{3}{16} \, {\Delta
...
\frac{3}{16} \, {\Delta v_0}^{5} e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 15 \, \sigma_{30}\right) + \frac{3}{8} \, {\Delta v_0}^{3} {\Delta v_1}^{2}
e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{25}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 15 \,
\sigma_{30}\right) + \frac{9}{16} \, {\Delta v_0} {\Delta v_1}^{4} e^{\left(-5 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} +
...
{\left(\mu_{2} - 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} + 8 \, \sigma_{33}\right)} + \frac{1}{2} \,
{\left({\left(\mu_{2} - 4 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3}
- 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 2 \, \sigma_{20} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + {\left(2 \, \sigma_{10}
...
\sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + \frac{1}{8} \, {\left({\left(\mu_{2} - 4 \,
...
\, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + \frac{1}{2} \, {\left(4 \, \sigma_{10} \cos\left(4 \,
\mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{1}
- 4 \, \sigma_{31}\right)} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} -
16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{4} + 2 \, {\left({\left(\mu_{1} - 4 \, \sigma_{31}\right)} \cos\left(2 \,
\mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 2 \,
\sigma_{10} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 8 \,
\sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} - {\left(2 \, \sigma_{20} \cos\left(2 \, \mu_{0} - 8 \,
...
\sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} + 2 \, {\left({\left(\mu_{1} - 4 \, \sigma_{31}\right)}
...
\sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} - \frac{1}{2} \, {\left(4 \, \sigma_{20} \cos\left(4 \, \mu_{0}
- 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} + {\left(\mu_{2} - 4 \,
\sigma_{32}\right)} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \,
\sigma_{30}\right)\right)} {\Delta v_0}^{3} {\Delta v_1} - \frac{3}{4} \, {\left({\left(\mu_{2} - 4 \,
\sigma_{32}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} - 4 \, \sigma_{20} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4
\, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1}^{2} - 3 \, {\left(4 \, \sigma_{10}
\cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} +
{\left(\mu_{1} - 4 \, \sigma_{31}\right)} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)}
\sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0}^{2} {\Delta v_1}^{2} + 2 \, {\left({\left(\mu_{1}
- 4 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} +
8 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{3} - {\left(2 \, \sigma_{20}
\cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} +
{\left(\mu_{2} - 4 \, \sigma_{32}\right)} e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{3} - 2 \, {\left({\left(\mu_{1} - 4
\, \sigma_{31}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8
\, \sigma_{33}\right)} - 4 \, \sigma_{10} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)}
\sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_0} {\Delta v_1}^{3} + \frac{1}{2} \, {\left(4 \,
\sigma_{20} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
...
\frac{1}{2} \, {\left({\left(\mu_{2} - 4 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 8 \, \sigma_{30}\right)
e^{\left(-4 \, \mu_{3} - 2 \, \sigma_{00} + 8 \, \sigma_{33}\right)} - 2 \, \sigma_{20} e^{\left(-4 \, \mu_{3} - 2 \,
...
\sigma_{33}\right)} \sin\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_1}^{4} - 3 \, {\left(\sigma_{21}
...
\sigma_{30}\right)\right)} {\left(\mu_{2} + \sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{3} -
...
v_0}^{3} - \frac{3}{2} \, {\left(\sigma_{11} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{31}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{2} \, {\left(\sigma_{11} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
\, \sigma_{31}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{2} \, {\left(\sigma_{11} \cos\left(\mu_{0} - 3 \,
...
\sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{9}{2} \, {\left(\sigma_{11}
...
v_1} + 3 \, {\left(\sigma_{21} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)}
\sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} - 9 \,
...
\sigma_{32}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + 3 \, {\left(\sigma_{21} e^{\left(-3 \, \mu_{3} - \frac{1}{2}
\, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right) + {\left(\sigma_{10}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} + {\left(\mu_{1} - 3 \, \sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + 3
\, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - 3 \, {\left(\sigma_{21} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} +
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} + 3 \, {\left(\sigma_{21} \cos\left(3 \,
...
v_1}^{2} + \frac{9}{2} \, {\left(\sigma_{11} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{10} \cos\left(3 \, \mu_{0} -
9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{1} - 3 \, \sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{1} - 3 \, \sigma_{10} + 3 \,
\sigma_{31}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{2} \, {\left(\sigma_{11} e^{\left(-3 \, \mu_{3} -
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{1} -
\sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{2} \, {\left(\sigma_{11}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} + {\left({\left(\mu_{1} - 3 \, \sigma_{31}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right)
e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-3 \,
\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \,
\sigma_{30}\right)\right)} {\left(\mu_{1} + \sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_1}^{3} +
\frac{3}{2} \, {\left(\sigma_{11} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{1} + 3 \, \sigma_{10} + 3 \,
\sigma_{31}\right)}\right)} {\Delta v_1}^{3} - {\left(\sigma_{21} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} +
...
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{3} + 3 \, {\left(\sigma_{21} e^{\left(-3 \, \mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right) +
{\left(\sigma_{10} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{9}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - 3 \, \sigma_{31}\right)} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{2} -
\sigma_{20} + 3 \, \sigma_{32}\right)}\right)} {\Delta v_1}^{3} + 3 \, {\left(2 \, {\left(\mu_{1} - 2 \,
...
{\Delta v_0}^{2} + 2 \, {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) + {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \,
...
\sigma_{30}\right)\right)} \sigma_{11}\right)} {\Delta v_0}^{2} + 3 \, {\left({\left(\sigma_{11} \cos\left(2 \, \mu_{0}
...
\sigma_{31}\right)}\right)} {\left(\mu_{2} + 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)} + 2 \, {\left({\left(\mu_{1} -
2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
\, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_0}^{2} + 4 \,
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{11}\right)} {\Delta v_0} {\Delta v_1} - 6 \, {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00}
...
4 \, \sigma_{30}\right)\right)} {\left(\mu_{1} - 2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\left(\mu_{2} - 2
\, \sigma_{20} + 2 \, \sigma_{32}\right)} + 2 \, {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \,
\sigma_{31}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_0} {\Delta v_1} + 3 \, {\left(2 \, {\left(\mu_{1} - 2 \,
\sigma_{31}\right)} \sigma_{21} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{1} + 2 \,
\sigma_{31}\right)} {\left(\mu_{1} - 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{11} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)}\right)}
{\Delta v_1}^{2} - 2 \, {\left({\left(\sigma_{11} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) + {\left(2 \, \sigma_{10} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \,
\sigma_{31}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} {\left(\mu_{1} - 2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\left(\mu_{1} - 2 \,
...
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{1} - 2 \, \sigma_{31}\right)}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{11}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left(\sigma_{11} \cos\left(2 \, \mu_{0}
- 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{1} -
2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
\, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{1} + 2 \, \sigma_{10} + 2 \,
...
2 \, \sigma_{31}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
\, \sigma_{33}\right)} - 2 \, \sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_1}^{2} -
...
\sigma_{10} + \sigma_{31}\right)} + 3 \, {\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
...
\sigma_{11}\right)} {\Delta v_0} - 4 \, {\left({\left({\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{21}\right)} {\Delta v_0} -
{\left({\left({\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
\sigma_{33}\right)} - \sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)}
\sigma_{11}\right)} {\Delta v_1} + 4 \, {\left({\left({\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00}
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
\sigma_{11}\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)} + 3 \, {\left(\sigma_{11} e^{\left(-\mu_{3} -
...
\sigma_{31}\right)}\right)} \sigma_{21}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{1}^{2} + \sigma_{11}\right)}
\mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)} \mu_{1} + 3 \, {\left(\mu_{1}^{2} + \sigma_{11}\right)} \sigma_{11}\right)}
\mu_{2} + 4 \, {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)} \sigma_{21}
"""
