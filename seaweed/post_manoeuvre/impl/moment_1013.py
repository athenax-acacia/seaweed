...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,0,1,3
# to recreate, then copy the file 'moment_1013.py' on top of this one.
...
def moment_1013(delta_v, mu, sigma):
         ...
         (mu3 - sigma_30 + sigma_33))) - delta_v1 * (
             ...
             (sigma_30 *
              ...
              (mu3 + sigma_30 + sigma_33))) + mu3 * (
                  mu3 * (mu0 * sigma_32 + mu2 * sigma_30 + mu3 *
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)}\right)} \sigma_{30} + 2 \, {\left(\sigma_{30} \cos\left(\mu_{0} -
...
\sigma_{33}\right)}\right)} \sigma_{33}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0} \mu_{2} +
\sigma_{20}\right)} \mu_{3} + \mu_{2} \sigma_{30} + \mu_{0} \sigma_{32}\right)} \mu_{3} + {\left(\mu_{2} \mu_{3} +
\sigma_{32}\right)} \sigma_{30} + {\left(\mu_{0} \mu_{3} + \sigma_{30}\right)} \sigma_{32} + {\left(\mu_{0} \mu_{2} +
\sigma_{20}\right)} \sigma_{33}\right)} \mu_{3} + {\left({\left(\mu_{2} \mu_{3} + \sigma_{32}\right)} \mu_{3} + \mu_{3}
\sigma_{32} + \mu_{2} \sigma_{33}\right)} \sigma_{30} + {\left({\left(\mu_{0} \mu_{3} + \sigma_{30}\right)} \mu_{3} +
\mu_{3} \sigma_{30} + \mu_{0} \sigma_{33}\right)} \sigma_{32} + 2 \, {\left({\left(\mu_{0} \mu_{2} + \sigma_{20}\right)}
\mu_{3} + \mu_{2} \sigma_{30} + \mu_{0} \sigma_{32}\right)} \sigma_{33}
"""
