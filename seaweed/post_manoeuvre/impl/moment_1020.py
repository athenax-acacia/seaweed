...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,0,2,0
# to recreate, then copy the file 'moment_1020.py' on top of this one.
...
def moment_1020(delta_v, mu, sigma):
        ...
        cos(2 * mu0 - 4 * sigma_30)) / 2 + delta_v0 * delta_v1 * (
            ...
            * sin(2 * mu0 - 4 * sigma_30)) - 2 * delta_v0 * (
                ...
                (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                 ...
                 sin(mu0 - sigma_30)) *
                (mu2 - sigma_20 + sigma_32)) + delta_v1**2 * (
                    mu0 - 2 * sigma_30
                ...
                ) + mu0 * sigma_22 + mu2 * sigma_20 + mu2 * (mu0 * mu2 +
                                                             sigma_20)
...
\sigma_{20} + \sigma_{32}\right)}\right)} {\Delta v_0} - 2 \, {\left(\sigma_{20} \cos\left(\mu_{0} - \sigma_{30}\right)
...
{\left(\mu_{0} \mu_{2} + \sigma_{20}\right)} \mu_{2} + \mu_{2} \sigma_{20} + \mu_{0} \sigma_{22}
"""
