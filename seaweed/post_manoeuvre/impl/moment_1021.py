...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,0,2,1
# to recreate, then copy the file 'moment_1021.py' on top of this one.
...
def moment_1021(delta_v, mu, sigma):
            ...
            (mu3 + 2 * sigma_30 + 2 * sigma_33)) / 2 - 2 * delta_v1 * (
                ...
                (mu3 + sigma_30 + sigma_33)) + mu3 * (
                    ...
                    (mu0 * mu2 + sigma_20)) + sigma_30 * (
                        mu2**2 + sigma_22) + 2 * sigma_32 * (mu0 * mu2 +
                                                             sigma_20)
...
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 2 \, {\left({\left(\sigma_{20} e^{\left(-\mu_{3} -
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0} - 2 \, {\left({\left(\sigma_{20}
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_1} + {\left({\left(\mu_{0} \mu_{2} +
\sigma_{20}\right)} \mu_{2} + \mu_{2} \sigma_{20} + \mu_{0} \sigma_{22}\right)} \mu_{3} + {\left(\mu_{2}^{2} +
\sigma_{22}\right)} \sigma_{30} + 2 \, {\left(\mu_{0} \mu_{2} + \sigma_{20}\right)} \sigma_{32}
"""
