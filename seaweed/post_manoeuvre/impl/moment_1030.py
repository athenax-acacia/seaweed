...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,0,3,0
# to recreate, then copy the file 'moment_1030.py' on top of this one.
...
def moment_1030(delta_v, mu, sigma):
            ...
            cos(3 * mu0 - 9 * sigma_30)) / 4 - 3 * delta_v1**3 * (
                ...
                (mu2 + sigma_20 + sigma_32)) + mu2 * (
                    ...
                    (mu0 * mu2 + sigma_20)) + sigma_20 * (
                        mu2**2 + sigma_22) + 2 * sigma_22 * (mu0 * mu2 +
                                                             sigma_20)
...
\sigma_{30}\right)\right)} {\Delta v_0}^{3} - \frac{3}{4} \, {\left({\left(\mu_{0} - 3 \, \sigma_{30}\right)}
...
{\Delta v_0}^{2} {\Delta v_1} - \frac{3}{4} \, {\left(\sigma_{00} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right)
...
{\Delta v_1}^{2} - \frac{3}{4} \, {\left({\left(\mu_{0} - 3 \, \sigma_{30}\right)} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} -
...
\sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} + \frac{3}{2} \, {\left({\left(\mu_{0} - 2 \,
\sigma_{30}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{20} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + 3 \, {\left(\sigma_{20}
...
\sigma_{32}\right)}\right)} {\Delta v_0} {\Delta v_1} + \frac{3}{2} \, {\left(\sigma_{20} \cos\left(2 \, \mu_{0} - 4 \,
...
{\Delta v_1}^{2} + \frac{3}{2} \, {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} {\left(\mu_{2} + 2 \,
\sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{20} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left(\sigma_{20} e^{\left(-\mu_{3} - \frac{1}{2} \,
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_0} - 3 \, {\left({\left(\sigma_{20}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_1} + {\left({\left(\mu_{0} \mu_{2} +
\sigma_{20}\right)} \mu_{2} + \mu_{2} \sigma_{20} + \mu_{0} \sigma_{22}\right)} \mu_{2} + {\left(\mu_{2}^{2} +
\sigma_{22}\right)} \sigma_{20} + 2 \, {\left(\mu_{0} \mu_{2} + \sigma_{20}\right)} \sigma_{22}
"""
