...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,0,3,1
# to recreate, then copy the file 'moment_1031.py' on top of this one.
...
def moment_1031(delta_v, mu, sigma):
    ...
    return delta_v0**3 * (
        ...
        (sigma_22 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
         ...
         (sigma_20 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
          ...
          sin(mu0 - sigma_30)) * (mu2 - sigma_20 + sigma_32)) + 2 * sigma_32 *
        (sigma_20 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
         sin(mu0 - sigma_30) +
        ...
        (sigma_20 *
         ...
         (mu2 - sigma_20 + sigma_32))) - delta_v1**3 * (
             sigma_30 * exp(-3 * mu3 - 9 * sigma_00 / 2 + 9 * sigma_33 / 2) *
             cos(3 * mu0 - 9 * sigma_30) +
...
\sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{4} \, {\left(\sigma_{30} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
\, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{3}{4} \, {\left(\sigma_{30} \cos\left(\mu_{0} - 3 \,
...
{\left(\mu_{0} - 3 \, \sigma_{30}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} - 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \, {\left(\sigma_{30} e^{\left(-3 \, \mu_{3} -
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} -
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{3}{4} \, {\left(\sigma_{30}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{2} \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)}
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0}^{2} + 3 \,
...
{\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \sigma_{30} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{32} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{20} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} + \frac{3}{2} \, {\left({\left(\sigma_{20} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{32}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left({\left(\sigma_{20} e^{\left(-\mu_{3} - \frac{1}{2} \,
...
\sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} +
\sigma_{32}\right)}\right)} \sigma_{32}\right)} {\Delta v_0} - 3 \, {\left({\left({\left(\sigma_{20} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} +
...
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} + \sigma_{20} +
\sigma_{32}\right)}\right)} \sigma_{32}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0} \mu_{2} +
\sigma_{20}\right)} \mu_{2} + \mu_{2} \sigma_{20} + \mu_{0} \sigma_{22}\right)} \mu_{2} + {\left(\mu_{2}^{2} +
\sigma_{22}\right)} \sigma_{20} + 2 \, {\left(\mu_{0} \mu_{2} + \sigma_{20}\right)} \sigma_{22}\right)} \mu_{3} +
{\left({\left(\mu_{2}^{2} + \sigma_{22}\right)} \mu_{2} + 2 \, \mu_{2} \sigma_{22}\right)} \sigma_{30} + 3 \,
