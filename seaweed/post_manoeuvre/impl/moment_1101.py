...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,1,0,1
# to recreate, then copy the file 'moment_1101.py' on top of this one.
...
def moment_1101(delta_v, mu, sigma):
...
{\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)}\right)} {\Delta v_0} + {\left(\sigma_{30} e^{\left(-\mu_{3} -
...
\sigma_{33}\right)}\right)} {\Delta v_1} + {\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{3} + \mu_{1} \sigma_{30} +
\mu_{0} \sigma_{31}
"""
