...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,1,0,3
# to recreate, then copy the file 'moment_1103.py' on top of this one.
...
def moment_1103(delta_v, mu, sigma):
...
def latex_1103():
    return r"""
-{\left({\left({\left(\sigma_{30} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00}
+ \frac{1}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{0} - \sigma_{30}\right)} \cos\left(\mu_{0} -
...
{\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{33} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{3} -
...
2 \, {\left(\sigma_{30} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)}\right)} \sigma_{33}\right)} {\Delta v_0} +
{\left({\left({\left(\sigma_{30} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{30} + {\left(\sigma_{00}
...
\sigma_{33}\right)} + {\left(\sigma_{33} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{3} - \sigma_{30} + \sigma_{33}\right)}\right)} \sigma_{30} +
2 \, {\left(\sigma_{30} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{3} - \sigma_{30} + \sigma_{33}\right)}\right)} \sigma_{33}\right)} {\Delta v_1} +
{\left({\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{3} + \mu_{1} \sigma_{30} + \mu_{0} \sigma_{31}\right)}
\mu_{3} + {\left(\mu_{1} \mu_{3} + \sigma_{31}\right)} \sigma_{30} + {\left(\mu_{0} \mu_{3} + \sigma_{30}\right)}
\sigma_{31} + {\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \sigma_{33}\right)} \mu_{3} + {\left({\left(\mu_{1} \mu_{3} +
\sigma_{31}\right)} \mu_{3} + \mu_{3} \sigma_{31} + \mu_{1} \sigma_{33}\right)} \sigma_{30} + {\left({\left(\mu_{0}
\mu_{3} + \sigma_{30}\right)} \mu_{3} + \mu_{3} \sigma_{30} + \mu_{0} \sigma_{33}\right)} \sigma_{31} + 2 \,
{\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{3} + \mu_{1} \sigma_{30} + \mu_{0} \sigma_{31}\right)}
\sigma_{33}
"""
