...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,1,1,2
# to recreate, then copy the file 'moment_1112.py' on top of this one.
...
def moment_1112(delta_v, mu, sigma):
            ...
            (mu3 - 2 * sigma_30 + 2 * sigma_33)) / 2 - delta_v1 * (
                ...
                (sigma_30 *
                 ...
                 (mu3 - sigma_30 + sigma_33))) + mu3 * (
                     mu3 * (mu0 * sigma_21 + mu1 * sigma_20 + mu2 *
                            (mu0 * mu1 + sigma_10)) + sigma_30 *
                     (mu1 * mu2 + sigma_21) + sigma_31 *
                     (mu0 * mu2 + sigma_20) + sigma_32 *
                     (mu0 * mu1 + sigma_10)) + sigma_30 * (
...
def latex_1112():
    return r"""
\frac{1}{2} \, {\left({\left(\sigma_{30} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
...
\sigma_{30} + 2 \, \sigma_{33}\right)} + {\left(2 \, \sigma_{30} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
\sigma_{30}\right)\right)} \sigma_{30} + {\left(2 \, \sigma_{00} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{0} - 2 \, \sigma_{30}\right)}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_0}^{2} + {\left({\left(\sigma_{30} \cos\left(2 \, \mu_{0} - 4
...
\sigma_{33}\right)} {\Delta v_0} {\Delta v_1} - \frac{1}{2} \, {\left({\left(\sigma_{30} e^{\left(-2 \, \mu_{3} - 2 \,
...
\sigma_{33}\right)}\right)} {\left(\mu_{3} - 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} + {\left(2 \, \sigma_{30}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{3} - 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{30} + {\left(2 \, \sigma_{00} \cos\left(2 \, \mu_{0} -
4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{0} - 2 \,
\sigma_{30}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{33}\right)} {\Delta v_1}^{2} - {\left({\left({\left(\sigma_{20} \cos\left(\mu_{0} -
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{30} + {\left({\left(\mu_{0} - \sigma_{30}\right)}
...
{\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)}\right)} \sigma_{30} + {\left(\sigma_{30} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{0} - \sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{3} + \sigma_{30} +
\sigma_{33}\right)}\right)} \sigma_{32} + {\left(\sigma_{20} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
...
\sigma_{33}\right)} {\Delta v_0} - {\left({\left({\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
- \sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{1} - \sigma_{31}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
\sigma_{30} + {\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00}
+ \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{31}\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{31} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
{\left(\sigma_{30} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0}
...
\sigma_{30} + \sigma_{33}\right)}\right)} \sigma_{31} + {\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \,
...
\sigma_{31}\right)}\right)} \sigma_{33}\right)} {\Delta v_0} - {\left({\left({\left(\sigma_{10} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{0} - \sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} + \sigma_{10} +
\sigma_{31}\right)}\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} + {\left({\left(\mu_{1} -
...
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{3} + \sigma_{30} +
\sigma_{33}\right)}\right)} \sigma_{31} + {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{0} - \sigma_{30}\right)}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
\sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)}
\sigma_{33}\right)} {\Delta v_1} + {\left({\left({\left(\sigma_{20} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0}
- \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)}\right)} {\left(\mu_{3}
- \sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{20} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
...
\sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{32} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2}
\, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)}\right)} \sigma_{32} + {\left(\sigma_{20} e^{\left(-\mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
\sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} +
\sigma_{32}\right)}\right)} \sigma_{33}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \mu_{2} + \mu_{1} \sigma_{20} + \mu_{0} \sigma_{21}\right)} \mu_{3} + {\left(\mu_{1} \mu_{2} +
\sigma_{21}\right)} \sigma_{30} + {\left(\mu_{0} \mu_{2} + \sigma_{20}\right)} \sigma_{31} + {\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \sigma_{32}\right)} \mu_{3} + {\left({\left(\mu_{1} \mu_{2} + \sigma_{21}\right)} \mu_{3} + \mu_{2}
\sigma_{31} + \mu_{1} \sigma_{32}\right)} \sigma_{30} + {\left({\left(\mu_{0} \mu_{2} + \sigma_{20}\right)} \mu_{3} +
\mu_{2} \sigma_{30} + \mu_{0} \sigma_{32}\right)} \sigma_{31} + {\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)}
\mu_{3} + \mu_{1} \sigma_{30} + \mu_{0} \sigma_{31}\right)} \sigma_{32} + {\left({\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \mu_{2} + \mu_{1} \sigma_{20} + \mu_{0} \sigma_{21}\right)} \sigma_{33}
"""
