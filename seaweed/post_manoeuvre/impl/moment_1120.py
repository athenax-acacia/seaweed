...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,1,2,0
# to recreate, then copy the file 'moment_1120.py' on top of this one.
...
def moment_1120(delta_v, mu, sigma):
    ...
    return delta_v0**3 * (
        ...
        * cos(mu0 - 3 * sigma_30)) / 4 - 3 * delta_v0**2 * delta_v1 * (
            ...
            * cos(3 * mu0 - 9 * sigma_30) + (mu0 - 3 * sigma_30) *
            ...
            sin(3 * mu0 - 9 * sigma_30)) / 4 + delta_v0**2 * delta_v1 * (
                sigma_00 * exp(-3 * mu3 - sigma_00 / 2 + 9 * sigma_33 / 2) *
                    ...
                    (mu2 - sigma_20 + sigma_32)) + mu2 * (
                        ...
                        (mu0 * mu1 + sigma_10)) + sigma_20 * (
                            mu1 * mu2 + sigma_21) + sigma_21 * (
                                mu0 * mu2 + sigma_20) + sigma_22 * (mu0 * mu1 +
                                                                    sigma_10)


def latex_1120():
    return r"""
-\frac{1}{4} \, {\left({\left(\mu_{0} - 3 \, \sigma_{30}\right)} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3
...
\mu_{0} - 9 \, \sigma_{30}\right)\right)} {\Delta v_0}^{3} + \frac{1}{4} \, {\left(\sigma_{00} \cos\left(\mu_{0} - 3 \,
...
{\Delta v_0}^{2} {\Delta v_1} - \frac{1}{4} \, {\left({\left(\mu_{0} - 3 \, \sigma_{30}\right)} \cos\left(\mu_{0} - 3 \,
\sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} -
...
v_1}^{2} + \frac{1}{4} \, {\left(\sigma_{00} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
...
\sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \, {\left({\left(\mu_{0} - 2 \,
\sigma_{30}\right)} {\left(\mu_{1} + 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{10} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + {\left(\sigma_{20} e^{\left(-2
...
\sigma_{32}\right)}\right)} {\Delta v_0}^{2} + 2 \, {\left(\sigma_{20} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
v_1} + {\left(\sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} -
...
2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\Delta v_0} {\Delta v_1} + \frac{1}{2} \, {\left(\sigma_{10}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
...
\sigma_{31}\right)}\right)} {\Delta v_1}^{2} + \frac{1}{2} \, {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)}
{\left(\mu_{1} + 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{10} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - {\left(\sigma_{20} e^{\left(-2 \, \mu_{3} - 2 \,
...
\sigma_{32}\right)}\right)} {\Delta v_1}^{2} - {\left({\left(\sigma_{20} \cos\left(\mu_{0} - \sigma_{30}\right)
...
+ \sigma_{20} + \sigma_{32}\right)} + {\left({\left(\mu_{2} - \sigma_{32}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)}
{\Delta v_0} - 2 \, {\left({\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
- \sigma_{20} + \sigma_{32}\right)} + {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
...
+ \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_0} - 2
...
\sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{21}\right)} {\Delta v_1} + {\left({\left(\sigma_{20}
...
\sigma_{20} + \sigma_{32}\right)}\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)} + {\left(\sigma_{20}
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{22}\right)} {\Delta v_1} + {\left({\left(\mu_{0} \mu_{1} +
