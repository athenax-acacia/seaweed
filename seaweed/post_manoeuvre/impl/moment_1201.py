...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,2,0,1
# to recreate, then copy the file 'moment_1201.py' on top of this one.
...
def moment_1201(delta_v, mu, sigma):
            ...
            (mu3 + 2 * sigma_30 + 2 * sigma_33)) / 2 + 2 * delta_v1 * (
                ...
                (mu3 - sigma_30 + sigma_33)) + mu3 * (
                    ...
                    (mu0 * mu1 + sigma_10)) + sigma_30 * (
                        mu1**2 + sigma_11) + 2 * sigma_31 * (mu0 * mu1 +
                                                             sigma_10)


def latex_1201():
    return r"""
\frac{1}{2} \, {\left(\sigma_{30} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \,
...
\sigma_{33}\right)} + \sigma_{30} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} -
{\left(\sigma_{30} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) + {\left(2 \, \sigma_{00} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2
...
\sigma_{30} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1} - \frac{1}{2} \, {\left(\sigma_{30} \cos\left(2
...
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} + \frac{1}{2} \, {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)}
{\left(\mu_{3} + 2 \, \sigma_{33}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{30} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 2 \, {\left({\left(\sigma_{10} \cos\left(\mu_{0} -
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_0} + 2 \, {\left({\left(\sigma_{10}
...
\sigma_{10} + \sigma_{31}\right)}\right)} {\left(\mu_{3} - \sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{10}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_1} + {\left({\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \mu_{1} + \mu_{1} \sigma_{10} + \mu_{0} \sigma_{11}\right)} \mu_{3} + {\left(\mu_{1}^{2} +
\sigma_{11}\right)} \sigma_{30} + 2 \, {\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \sigma_{31}
"""
