...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,2,1,1
# to recreate, then copy the file 'moment_1211.py' on top of this one.
...
def moment_1211(delta_v, mu, sigma):
    ...
    return -delta_v0**3 * (
        sigma_30 * exp(-3 * mu3 - 9 * sigma_00 / 2 + 9 * sigma_33 / 2) *
        ...
        (sigma_10 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
         ...
         (2 * sigma_00 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          cos(2 * mu0 - 4 * sigma_30) +
          (mu0 - 2 * sigma_30) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          sin(2 * mu0 - 4 * sigma_30)) * (mu1 - 2 * sigma_10 + 2 * sigma_31)) *
        ...
        (sigma_20 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
         ...
         (-2 * sigma_00 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          sin(2 * mu0 - 4 * sigma_30) +
          (mu0 - 2 * sigma_30) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          cos(2 * mu0 - 4 * sigma_30)) * (mu2 + 2 * sigma_20 + 2 * sigma_32)) *
        (mu3 + 2 * sigma_30 + 2 * sigma_33)
    ) / 2 + delta_v0**2 * (
        sigma_30 *
        (mu2 - 2 * sigma_32) * exp(-2 * mu3 + 2 * sigma_33) + sigma_32 *
        ...
        (sigma_10 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
         ...
         (-2 * sigma_00 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          sin(2 * mu0 - 4 * sigma_30) +
          (mu0 - 2 * sigma_30) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          cos(2 * mu0 - 4 * sigma_30)) * (mu1 + 2 * sigma_10 + 2 * sigma_31)) *
        (mu3 + 2 * sigma_30 + 2 * sigma_33)
    ) - delta_v0 * delta_v1 * (
        sigma_30 *
        (2 * sigma_20 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
        ...
        (sigma_20 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
         ...
         (2 * sigma_00 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          cos(2 * mu0 - 4 * sigma_30) +
          (mu0 - 2 * sigma_30) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
          sin(2 * mu0 - 4 * sigma_30)) * (mu2 - 2 * sigma_20 + 2 * sigma_32)) *
        (mu3 - 2 * sigma_30 + 2 * sigma_33)) - delta_v0 * (
            ...
            (sigma_11 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
             ...
             (mu1 - sigma_10 + sigma_31)) + 2 * sigma_31 *
            (sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
             sin(mu0 - sigma_30) +
            ...
            (sigma_21 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
             ...
             (mu2 + sigma_20 + sigma_32)) + sigma_31 *
            ...
            (sigma_10 *
             ...
             (mu1 + sigma_10 + sigma_31))) + 2 * delta_v1 * (
                 sigma_30 *
                 (sigma_21 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                  sin(mu0 - sigma_30) +
                  (sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
...
def latex_1211():
    return r"""
-\frac{1}{4} \, {\left(\sigma_{30} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{1}{4} \, {\left(\sigma_{30} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
\, \sigma_{33}\right)}\right)} {\Delta v_0}^{3} - \frac{1}{4} \, {\left(\sigma_{30} \cos\left(\mu_{0} - 3 \,
...
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{3}{4} \, {\left(\sigma_{30}
...
v_1} + \frac{3}{4} \, {\left(\sigma_{30} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{00} \cos\left(3 \, \mu_{0} -
9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{0} - 3 \, \sigma_{30}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} - 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{1}{4} \, {\left(\sigma_{30} e^{\left(-3 \, \mu_{3} -
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{3} -
\sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{1}{4} \, {\left(\sigma_{30}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\frac{1}{4} \, {\left(\sigma_{30} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{3} + 3 \, \sigma_{30} + 3 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{3} + \frac{1}{2} \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)}
\sigma_{30} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{32}
e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} {\left(\mu_{2} + 2
\, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{20} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \,
{\left({\left(\sigma_{20} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
...
{\left(\mu_{2} + 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\left(\mu_{3} + 2 \, \sigma_{30} + 2 \,
\sigma_{33}\right)} + {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_0}^{2} +
...
2 \, \sigma_{10} + 2 \, \sigma_{31}\right)}\right)} {\left(\mu_{3} - 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} +
...
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_0}^{2} + 2 \,
...
{\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3}
- 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_0} {\Delta
...
\mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
{\left(\mu_{2} - 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)}\right)} {\left(\mu_{3} - 2 \, \sigma_{30} + 2 \,
\sigma_{33}\right)} + {\left(2 \, \sigma_{20} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} -
2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{2} - 2 \, \sigma_{32}\right)} e^{\left(-2 \, \mu_{3} - 2 \,
\sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{30} + {\left(2
...
v_1} + \frac{1}{2} \, {\left({\left(\mu_{2} - 2 \, \sigma_{32}\right)} \sigma_{30} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + {\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{32} e^{\left(-2 \, \mu_{3} + 2 \,
...
{\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3}
- 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{32}\right)} {\Delta v_1}^{2} -
{\left({\left(\sigma_{10} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} -
4 \, \sigma_{30}\right) + {\left(2 \, \sigma_{00} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \,
\mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3}
- 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{1} -
...
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_1}^{2} - 2 \,
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{21}\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} +
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{2} + \sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{30} + {\left(\sigma_{20} \cos\left(\mu_{0} -
...
\sigma_{32}\right)}\right)} \sigma_{31} + {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
...
\sigma_{32}\right)} {\Delta v_0} - {\left({\left({\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
\sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{30} +
...
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{31}\right)} {\Delta v_0} -
{\left({\left({\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} + {\left({\left(\mu_{0} - \sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
...
\sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{11}\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} +
{\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} + {\left({\left(\mu_{1} - \sigma_{31}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{10} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{30} + 2 \, {\left(\sigma_{10} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} +
{\left({\left(\mu_{0} - \sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \,
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} + \sigma_{10} +
\sigma_{31}\right)}\right)} \sigma_{31}\right)} {\Delta v_1} + 2 \, {\left({\left({\left(\sigma_{10} e^{\left(-\mu_{3} -
...
\sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{30} + {\left(\sigma_{20} e^{\left(-\mu_{3} - \frac{1}{2} \,
...
\sigma_{32}\right)}\right)} \sigma_{31} + {\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0}
- \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)}
\sigma_{32}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{1} + \mu_{1}
\sigma_{10} + \mu_{0} \sigma_{11}\right)} \mu_{2} + {\left(\mu_{1}^{2} + \sigma_{11}\right)} \sigma_{20} + 2 \,
{\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \sigma_{21}\right)} \mu_{3} + {\left({\left(\mu_{1}^{2} +
\sigma_{11}\right)} \mu_{2} + 2 \, \mu_{1} \sigma_{21}\right)} \sigma_{30} + 2 \, {\left({\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \mu_{2} + \mu_{1} \sigma_{20} + \mu_{0} \sigma_{21}\right)} \sigma_{31} + {\left({\left(\mu_{0}
\mu_{1} + \sigma_{10}\right)} \mu_{1} + \mu_{1} \sigma_{10} + \mu_{0} \sigma_{11}\right)} \sigma_{32}
"""
