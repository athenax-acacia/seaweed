...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,3,0,1
# to recreate, then copy the file 'moment_1301.py' on top of this one.
...
def moment_1301(delta_v, mu, sigma):
    ...
    return -delta_v0**3 * (
        ...
        (mu3 - 2 * sigma_30 + 2 * sigma_33)) - 3 * delta_v0 * (
            ...
            (mu3 - sigma_30 + 3 * sigma_33)) / 4 - 3 * delta_v1**2 * (
                sigma_30 *
                (-2 * sigma_10 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
...
def latex_1301():
    return r"""
-\frac{3}{4} \, {\left(\sigma_{30} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
- 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} + \frac{3}{4} \, {\left(\sigma_{30}
...
{\left(\mu_{3} - \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{3}{4} \,
...
{\left(\mu_{3} - 3 \, \sigma_{30} + 3 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{3} + \frac{3}{4} \,
...
\frac{3}{2} \, {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \sigma_{30} e^{\left(-2 \, \mu_{3} + 2 \,
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_0}^{2} - 3 \,
...
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{31}\right)} {\Delta v_0} {\Delta v_1} + \frac{3}{2} \,
{\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \sigma_{30} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{31} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} {\left(\mu_{1} + 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{10} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\Delta v_1}^{2} - \frac{3}{2} \, {\left({\left(\sigma_{10} \cos\left(2 \, \mu_{0} - 4 \,
...
{\left(\mu_{3} + 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} -
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{31}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left({\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right)
...
{\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} + {\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{31}\right)} {\Delta v_0} + 3 \,
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{11}\right)} {\left(\mu_{3} - \sigma_{30} +
\sigma_{33}\right)} + {\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{31}\right)} {\Delta v_1} +
...
\sigma_{11}\right)} \mu_{3} + {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)}
\sigma_{30} + 3 \, {\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{1} + \mu_{1} \sigma_{10} + \mu_{0}
\sigma_{11}\right)} \sigma_{31}
"""
