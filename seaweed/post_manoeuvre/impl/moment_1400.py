...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 1,4,0,0
# to recreate, then copy the file 'moment_1400.py' on top of this one.
...
def moment_1400(delta_v, mu, sigma):
        ...
        cos(2 * mu0 - 8 * sigma_30)) / 2 - delta_v0**3 * delta_v1 * (
            ...
            * sin(4 * mu0 - 16 * sigma_30)) / 2 - delta_v0**3 * delta_v1 * (
                ...
                * sin(3 * mu0 - 9 * sigma_30) +
                ...
                (mu1 + 2 * sigma_10 + 2 * sigma_31)) + 3 * delta_v0**2 * (
                    sigma_10 *
                     ...
                     (sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                      ...
                      (-sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                       ...
                       (mu0 - sigma_30) * exp(-mu3 - sigma_00 / 2 + sigma_33 /
                                              2) * cos(mu0 - sigma_30)) *
                      (mu1 + sigma_10 + sigma_31)) *
                     (mu1 + sigma_10 + sigma_31))) + 3 * delta_v1**4 * (
                         mu0 - 4 * sigma_30
...
\sigma_{30}\right)} \cos\left(4 \, \mu_{0} - 16 \, \sigma_{30}\right) e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \,
\sigma_{33}\right)} - 4 \, \sigma_{00} e^{\left(-4 \, \mu_{3} - 8 \, \sigma_{00} + 8 \, \sigma_{33}\right)} \sin\left(4
\, \mu_{0} - 16 \, \sigma_{30}\right)\right)} {\Delta v_1}^{4} - 3 \, {\left(\sigma_{10} \cos\left(\mu_{0} - 3 \,
...
\sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_0}^{3} - {\left(\sigma_{10} \cos\left(3 \, \mu_{0} - 9 \,
...
{\left(\mu_{1} + 3 \, \sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_0}^{3} + 3 \, {\left(\sigma_{10}
e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \,
\sigma_{30}\right) + {\left(3 \, \sigma_{00} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} -
\frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - 3 \, \sigma_{30}\right)} e^{\left(-3
...
v_1} + 3 \, {\left(\sigma_{10} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)}
...
- 3 \, {\left(\sigma_{10} \cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
3 \, \sigma_{30}\right)\right)} {\left(\mu_{1} + \sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_0} {\Delta
v_1}^{2} + 3 \, {\left(\sigma_{10} \cos\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2}
...
\sigma_{31}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - {\left(\sigma_{10} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \,
...
- 3 \, \sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_1}^{3} + 3 \, {\left(\sigma_{10} e^{\left(-3 \, \mu_{3}
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{1} -
\sigma_{10} + 3 \, \sigma_{31}\right)}\right)} {\Delta v_1}^{3} + 3 \, {\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)}
\sigma_{10} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{11}
e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} {\left(\mu_{1} + 2
\, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{10} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)}\right)} {\left(\mu_{1} + 2 \, \sigma_{31}\right)}\right)} {\Delta v_0}^{2} + 3 \,
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{11}\right)} {\Delta v_0}^{2} - 6 \,
...
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{11}\right)} {\Delta v_0} {\Delta v_1} + 3 \,
{\left({\left(\mu_{1} - 2 \, \sigma_{31}\right)} \sigma_{10} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{11} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} {\left(\mu_{1} + 2 \, \sigma_{31}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{10} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{1} + 2 \,
\sigma_{31}\right)}\right)} {\Delta v_1}^{2} - 3 \, {\left({\left(\sigma_{10} \cos\left(2 \, \mu_{0} - 4 \,
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{11}\right)} {\Delta v_1}^{2} - 4 \, {\left({\left({\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right)
...
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)} + {\left(\sigma_{11} \cos\left(\mu_{0} - \sigma_{30}\right)
...
2 \, {\left(\sigma_{10} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} + \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{11}\right)} {\Delta v_0} + 4 \,
{\left({\left({\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{10} + {\left(\sigma_{00}
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{11}\right)} {\left(\mu_{1} - \sigma_{10} +
\sigma_{31}\right)} + {\left(\sigma_{11} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{11}\right)} {\Delta v_1} +
{\left({\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{1} + \mu_{1} \sigma_{10} + \mu_{0} \sigma_{11}\right)}
\mu_{1} + {\left(\mu_{1}^{2} + \sigma_{11}\right)} \sigma_{10} + 2 \, {\left(\mu_{0} \mu_{1} + \sigma_{10}\right)}
\sigma_{11}\right)} \mu_{1} + {\left({\left(\mu_{1}^{2} + \sigma_{11}\right)} \mu_{1} + 2 \, \mu_{1} \sigma_{11}\right)}
\sigma_{10} + 3 \, {\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{1} + \mu_{1} \sigma_{10} + \mu_{0}
\sigma_{11}\right)} \sigma_{11}
"""
