...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 2,0,2,0
# to recreate, then copy the file 'moment_2020.py' on top of this one.
...
def moment_2020(delta_v, mu, sigma):
            ...
            (mu0 + 2 * sigma_00 + 2 * sigma_30)) / 2 - 2 * delta_v1 * (
                ...
                (mu2 + sigma_20 + sigma_32)) + mu2 * (
                    ...
                    (mu0**2 + sigma_00)) + 2 * sigma_20 * (
                        mu0 * mu2 + sigma_20) + sigma_22 * (mu0**2 + sigma_00)
...
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 2 \, {\left({\left(\sigma_{00} e^{\left(-\mu_{3} -
...
\sigma_{30}\right)}\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)} + 2 \, {\left(\sigma_{00}
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{20}\right)} {\Delta v_0} - 2 \,
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{20}\right)} {\Delta v_1} +
{\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{2} + 2 \, \mu_{0} \sigma_{20}\right)} \mu_{2} + 2 \, {\left(\mu_{0}
\mu_{2} + \sigma_{20}\right)} \sigma_{20} + {\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{22}
"""
