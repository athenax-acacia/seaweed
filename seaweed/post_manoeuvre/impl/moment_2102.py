...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 2,1,0,2
# to recreate, then copy the file 'moment_2102.py' on top of this one.
...
def moment_2102(delta_v, mu, sigma):
        ...
        (2 * sigma_30 *
         ...
         (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
          ...
          (-sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
           sin(mu0 - sigma_30) + (mu0 - sigma_30) *
           exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) * cos(mu0 - sigma_30)) *
          (mu0 + sigma_00 + sigma_30)) * (mu3 + sigma_30 + sigma_33)) *
        (mu3 + sigma_30 + sigma_33)) + delta_v1 * (
            ...
            (mu3 - sigma_30 + sigma_33)) + mu3 * (
                ...
                (mu0**2 + sigma_00)) + 2 * sigma_30 * (
                    ...
                    (mu0 * mu1 + sigma_10)) + sigma_31 * (
                        2 * mu0 * sigma_30 + mu3 *
                        (mu0**2 + sigma_00)) + sigma_33 * (2 * mu0 * sigma_10 +
                                                           mu1 *
                                                           (mu0**2 + sigma_00))
...
\sigma_{30}\right)\right)} {\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} {\left(\mu_{3} + \sigma_{30} +
\sigma_{33}\right)} + 2 \, {\left({\left(\mu_{0} - \sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\sigma_{30}\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{30} \cos\left(\mu_{0} -
...
\sigma_{33}\right)}\right)} \sigma_{30} + {\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
...
\sigma_{33}\right)} {\Delta v_0} + {\left({\left({\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
...
- \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{0} - \sigma_{00} + \sigma_{30}\right)}\right)} {\left(\mu_{3}
- \sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
\sigma_{30}\right)} {\left(\mu_{3} - \sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{30} e^{\left(-\mu_{3} -
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{3} - \sigma_{30} +
\sigma_{33}\right)}\right)} \sigma_{30} + {\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0}
- \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{0} - \sigma_{00} + \sigma_{30}\right)}\right)}
\sigma_{33}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0}
\sigma_{10}\right)} \mu_{3} + 2 \, {\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \sigma_{30} + {\left(\mu_{0}^{2} +
\sigma_{00}\right)} \sigma_{31}\right)} \mu_{3} + 2 \, {\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{3} +
\mu_{1} \sigma_{30} + \mu_{0} \sigma_{31}\right)} \sigma_{30} + {\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{3}
+ 2 \, \mu_{0} \sigma_{30}\right)} \sigma_{31} + {\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0}
\sigma_{10}\right)} \sigma_{33}
"""
