...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 2,1,1,1
# to recreate, then copy the file 'moment_2111.py' on top of this one.
...
def moment_2111(delta_v, mu, sigma):
    ...
    return delta_v0**2 * (
        ...
        (mu3 + 2 * sigma_30 + 2 * sigma_33)) - delta_v0 * (
            ...
            (sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
             ...
             (mu1 - sigma_10 + sigma_31)) + sigma_31 *
            (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
             sin(mu0 - sigma_30) +
             (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
              cos(mu0 - sigma_30) + (mu0 - sigma_30) *
            ...
            (mu3 - sigma_30 + sigma_33)) - delta_v0 * (
                ...
                (mu3 - sigma_30 + sigma_33)) + mu3 * (
                    ...
                    (mu0**2 + sigma_00)) + 2 * sigma_30 * (
                        ...
                        (mu0 * mu1 + sigma_10)) + sigma_31 * (
                            2 * mu0 * sigma_20 + mu2 *
                            (mu0**2 + sigma_00)) + sigma_32 * (
...
\sigma_{30}\right)\right)} \sigma_{30}\right)} {\Delta v_0}^{2} + {\left({\left(\sigma_{00} \cos\left(2 \, \mu_{0} - 4
...
{\left(\mu_{3} + 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} + 2 \, {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)}
...
\sigma_{30}\right)\right)} \sigma_{30}\right)} {\Delta v_0} {\Delta v_1} - \frac{1}{2} \, {\left({\left(\sigma_{00}
...
\sigma_{30}\right)}\right)} {\left(\mu_{3} - 2 \, \sigma_{30} + 2 \, \sigma_{33}\right)} + 2 \, {\left(2 \, \sigma_{00}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{30}\right)} {\Delta v_1}^{2} -
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{32}\right)} {\Delta v_0} -
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{10}\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
...
\sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{31}\right)} {\Delta v_0} - {\left({\left({\left(\sigma_{00}
\cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
\sigma_{33}\right)} + {\left({\left(\mu_{0} - \sigma_{30}\right)} \cos\left(\mu_{0} - \sigma_{30}\right)
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{31}\right)} {\Delta v_1} +
{\left({\left({\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
...
\, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{20}\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)} + 2 \, {\left(\sigma_{20} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0}
- \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{2} - \sigma_{20} + \sigma_{32}\right)}\right)} \sigma_{30} +
...
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2}
\, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{0} -
\sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{32}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0}^{2} +
\sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)} \mu_{2} + 2 \, {\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \sigma_{20} + {\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{21}\right)} \mu_{3} + 2 \,
{\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{2} + \mu_{1} \sigma_{20} + \mu_{0} \sigma_{21}\right)}
\sigma_{30} + {\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{2} + 2 \, \mu_{0} \sigma_{20}\right)} \sigma_{31} +
{\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)} \sigma_{32}
"""
