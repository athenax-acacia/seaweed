...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 2,2,0,0
# to recreate, then copy the file 'moment_2200.py' on top of this one.
...
def moment_2200(delta_v, mu, sigma):
    ...
    return delta_v0**2 * (
        ...
        (mu0 - 2 * sigma_00 + 2 * sigma_30)) - 2 * delta_v0 * (
            ...
            (-2 * sigma_00 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
             ...
             (mu0 - 2 * sigma_30) * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33)
             * cos(2 * mu0 - 4 * sigma_30)) *
            (mu0 + 2 * sigma_00 + 2 * sigma_30)) / 2 + 2 * delta_v1 * (
                2 * sigma_10 *
                (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                 cos(mu0 - sigma_30) +
                ...
                (mu1 - sigma_10 + sigma_31)) + mu1 * (
                    ...
                    (mu0**2 + sigma_00)) + 2 * sigma_10 * (
                        mu0 * mu1 + sigma_10) + sigma_11 * (mu0**2 + sigma_00)


def latex_2200():
    return r"""
\frac{1}{2} \, {\left(\sigma_{00} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \,
...
{\left(\mu_{0} + 2 \, \sigma_{00} + 2 \, \sigma_{30}\right)}\right)} {\Delta v_0}^{2} + \frac{1}{2} \,
{\left({\left(\mu_{0} + 2 \, \sigma_{30}\right)} {\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{00} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_0}^{2} -
{\left(\sigma_{00} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
...
\sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{0} - 2 \,
\sigma_{00} + 2 \, \sigma_{30}\right)}\right)} {\Delta v_0} {\Delta v_1} - \frac{1}{2} \, {\left(\sigma_{00} \cos\left(2
...
\sigma_{30}\right)}\right)} {\Delta v_1}^{2} + \frac{1}{2} \, {\left({\left(\mu_{0} + 2 \, \sigma_{30}\right)}
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{00} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\Delta v_1}^{2} - 2 \, {\left({\left(\sigma_{00} \cos\left(\mu_{0} -
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{10}\right)} {\Delta v_0} + 2 \, {\left({\left(\sigma_{00}
...
\sigma_{00} + \sigma_{30}\right)}\right)} {\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)} + 2 \, {\left(\sigma_{00}
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{10}\right)} {\Delta v_1} +
{\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)} \mu_{1} + 2 \, {\left(\mu_{0}
\mu_{1} + \sigma_{10}\right)} \sigma_{10} + {\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{11}
"""
