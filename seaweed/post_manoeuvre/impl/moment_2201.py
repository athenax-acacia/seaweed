...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 2,2,0,1
# to recreate, then copy the file 'moment_2201.py' on top of this one.
...
def moment_2201(delta_v, mu, sigma):
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{31}\right)} {\Delta v_0} + 2 \,
...
\sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{31}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0}^{2} +
\sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)} \mu_{1} + 2 \, {\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \sigma_{10} + {\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{11}\right)} \mu_{3} + 2 \,
{\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{1} + \mu_{1} \sigma_{10} + \mu_{0} \sigma_{11}\right)}
\sigma_{30} + 2 \, {\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)}
\sigma_{31}
"""
