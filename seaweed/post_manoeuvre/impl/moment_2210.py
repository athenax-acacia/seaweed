...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 2,2,1,0
# to recreate, then copy the file 'moment_2210.py' on top of this one.
...
def moment_2210(delta_v, mu, sigma):
    ...
    return -delta_v0**3 * (
        ...
        (mu2 + 2 * sigma_20 + 2 * sigma_32)) / 2 + delta_v0**2 * (
            2 * sigma_20 *
             ...
             * cos(3 * mu0 - 9 * sigma_30) + (mu0 - 3 * sigma_30) *
             ...
             sin(3 * mu0 - 9 * sigma_30)) * (mu0 - 3 * sigma_00 + 3 * sigma_30)
            ...
            (mu2 - 2 * sigma_20 + 2 * sigma_32)) - delta_v0 * (
                ...
                (sigma_10 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                 ...
                 (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                  ...
                  sin(mu0 - sigma_30)) *
                 (mu1 - sigma_10 + sigma_31)) + sigma_11 *
                (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                 sin(mu0 - sigma_30) +
                 (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
                  cos(mu0 - sigma_30) +
                ...
                * cos(3 * mu0 - 9 * sigma_30) +
                ...
                (mu2 + 2 * sigma_20 + 2 * sigma_32)) / 2 + delta_v1**2 * (
                    ...
                    (mu2 - sigma_20 + sigma_32)) + mu2 * (
                        mu1 * (2 * mu0 * sigma_10 + mu1 *
                               (mu0**2 + sigma_00)) + 2 * sigma_10 *
                        (mu0 * mu1 + sigma_10) + sigma_11 *
                        (mu0**2 + sigma_00)) + 2 * sigma_20 * (
                            mu0 * sigma_11 + mu1 * sigma_10 + mu1 *
                            (mu0 * mu1 + sigma_10)) + 2 * sigma_21 * (
                                2 * mu0 * sigma_10 + mu1 * (mu0**2 + sigma_00))


def latex_2210():
    return r"""
-\frac{1}{4} \, {\left(\sigma_{00} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{30}\right)}\right)} {\Delta v_0}^{3} - \frac{1}{4} \, {\left(\sigma_{00} e^{\left(-3 \, \mu_{3} - \frac{1}{2} \,
...
\frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{0} - \sigma_{00} + 3
\, \sigma_{30}\right)}\right)} {\Delta v_0}^{3} - \frac{1}{4} \, {\left(\sigma_{00} \cos\left(\mu_{0} - 3 \,
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{0} +
\sigma_{00} + 3 \, \sigma_{30}\right)}\right)} {\Delta v_0}^{2} {\Delta v_1} - \frac{3}{4} \, {\left(\sigma_{00}
...
\sigma_{30}\right)\right)} {\left(\mu_{0} + 3 \, \sigma_{00} + 3 \, \sigma_{30}\right)}\right)} {\Delta v_0}^{2} {\Delta
v_1} + \frac{3}{4} \, {\left(\sigma_{00} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right) + {\left(3 \, \sigma_{00} \cos\left(3 \, \mu_{0} -
9 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} +
{\left(\mu_{0} - 3 \, \sigma_{30}\right)} e^{\left(-3 \, \mu_{3} - \frac{9}{2} \, \sigma_{00} + \frac{9}{2} \,
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{0} - 3 \, \sigma_{00} + 3 \,
...
\sigma_{00} + \frac{9}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - 3 \, \sigma_{30}\right)\right)} {\left(\mu_{0} -
\sigma_{00} + 3 \, \sigma_{30}\right)}\right)} {\Delta v_0} {\Delta v_1}^{2} - \frac{1}{4} \, {\left(\sigma_{00}
\cos\left(\mu_{0} - 3 \, \sigma_{30}\right) e^{\left(-3 \, \mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{9}{2} \,
...
\sigma_{33}\right)} \sin\left(3 \, \mu_{0} - 9 \, \sigma_{30}\right)\right)} {\left(\mu_{0} + 3 \, \sigma_{00} + 3 \,
\sigma_{30}\right)}\right)} {\Delta v_1}^{3} + \frac{1}{2} \, {\left(2 \, {\left(\mu_{0} - 2 \, \sigma_{30}\right)}
\sigma_{20} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{0} + 2 \, \sigma_{30}\right)}
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + \sigma_{00} e^{\left(-2 \,
\mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{2} + 2 \, \sigma_{32}\right)}\right)} {\Delta v_0}^{2} +
{\left({\left(\sigma_{00} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} -
...
- 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{0} -
2 \, \sigma_{00} + 2 \, \sigma_{30}\right)}\right)} {\left(\mu_{1} - 2 \, \sigma_{10} + 2 \, \sigma_{31}\right)} + 2 \,
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{10}\right)} {\Delta v_0}^{2} +
...
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{20}\right)} {\Delta v_0}^{2} + 2 \, {\left({\left(\sigma_{00} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)}
...
\sigma_{30}\right)\right)} {\left(\mu_{0} + 2 \, \sigma_{00} + 2 \, \sigma_{30}\right)}\right)} {\left(\mu_{1} + 2 \,
\sigma_{10} + 2 \, \sigma_{31}\right)} + 2 \, {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} \cos\left(2 \, \mu_{0} -
...
\sigma_{30}\right)\right)} \sigma_{10}\right)} {\Delta v_0} {\Delta v_1} - {\left({\left(\sigma_{00} e^{\left(-2 \,
...
\sigma_{30}\right)}\right)} {\left(\mu_{2} - 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)} + 2 \, {\left(2 \, \sigma_{00}
\cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} +
{\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)}
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{20}\right)} {\Delta v_0} {\Delta v_1} + \frac{1}{2} \,
{\left(2 \, {\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{20} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
{\left({\left(\mu_{0} + 2 \, \sigma_{30}\right)} {\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} + 2 \,
\sigma_{33}\right)} + \sigma_{00} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{2} + 2 \,
\sigma_{32}\right)}\right)} {\Delta v_1}^{2} - {\left({\left(\sigma_{00} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2
...
\sigma_{30}\right)\right)} {\left(\mu_{0} - 2 \, \sigma_{00} + 2 \, \sigma_{30}\right)}\right)} {\left(\mu_{1} - 2 \,
\sigma_{10} + 2 \, \sigma_{31}\right)} + 2 \, {\left(2 \, \sigma_{00} \cos\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} + {\left(\mu_{0} - 2 \, \sigma_{30}\right)}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{10}\right)} {\Delta v_1}^{2} - \frac{1}{2} \, {\left({\left(\sigma_{00} \cos\left(2
...
\sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} {\left(\mu_{0} + 2 \, \sigma_{00} + 2 \,
\sigma_{30}\right)}\right)} {\left(\mu_{2} + 2 \, \sigma_{20} + 2 \, \sigma_{32}\right)} + 2 \, {\left({\left(\mu_{0} -
...
\sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)} \sigma_{20}\right)} {\Delta v_1}^{2} -
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{10}\right)} {\left(\mu_{1} -
\sigma_{10} + \sigma_{31}\right)} + 2 \, {\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
...
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{10} +
...
\sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{11}\right)} {\Delta v_0} - 2 \, {\left({\left({\left(\sigma_{00}
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{21}\right)} {\Delta v_0} -
...
e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} - \sigma_{00} e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{11}\right)} {\Delta v_1} + 2 \,
{\left({\left({\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} -
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3}
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
...
\, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} +
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{10}\right)} {\left(\mu_{2} -
\sigma_{20} + \sigma_{32}\right)} + 2 \, {\left(\sigma_{10} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right) + {\left(\sigma_{00} \cos\left(\mu_{0} -
\sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0}
- \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)}
\sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)}\right)} \sigma_{20} +
...
\sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} + {\left(\mu_{0} - \sigma_{30}\right)} e^{\left(-\mu_{3} - \frac{1}{2}
\, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} {\left(\mu_{0} -
\sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{21}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0}^{2} +
\sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)} \mu_{1} + 2 \, {\left(\mu_{0} \mu_{1} +
\sigma_{10}\right)} \sigma_{10} + {\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{11}\right)} \mu_{2} + 2 \,
{\left({\left(\mu_{0} \mu_{1} + \sigma_{10}\right)} \mu_{1} + \mu_{1} \sigma_{10} + \mu_{0} \sigma_{11}\right)}
\sigma_{20} + 2 \, {\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)}
\sigma_{21}
"""
