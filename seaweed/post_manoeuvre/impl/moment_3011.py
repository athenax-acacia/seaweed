...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 3,0,1,1
# to recreate, then copy the file 'moment_3011.py' on top of this one.
...
def moment_3011(delta_v, mu, sigma):
        ...
        (mu3 - sigma_30 + sigma_33)) - delta_v1 * (
            ...
            (mu3 + sigma_30 + sigma_33)) + mu3 * (
                ...
                (mu0**2 + sigma_00)) + 3 * sigma_30 * (
                    2 * mu0 * sigma_20 + mu2 *
                    (mu0**2 + sigma_00)) + sigma_32 * (2 * mu0 * sigma_00 +
                                                       mu0 *
                                                       (mu0**2 + sigma_00))
...
\frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{00}\right)} {\left(\mu_{3} -
\sigma_{30} + \sigma_{33}\right)} + 3 \, {\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
...
\sigma_{30}\right)} {\Delta v_0} - {\left({\left({\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right)
...
\sigma_{30}\right)\right)} \sigma_{00}\right)} {\left(\mu_{3} + \sigma_{30} + \sigma_{33}\right)} + 3 \,
{\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right) e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2}
...
\frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
{\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{30}\right)} {\Delta v_1} +
{\left({\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{0} + 2 \, \mu_{0} \sigma_{00}\right)} \mu_{2} + 3 \,
{\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{20}\right)} \mu_{3} + 3 \, {\left({\left(\mu_{0}^{2} +
\sigma_{00}\right)} \mu_{2} + 2 \, \mu_{0} \sigma_{20}\right)} \sigma_{30} + {\left({\left(\mu_{0}^{2} +
\sigma_{00}\right)} \mu_{0} + 2 \, \mu_{0} \sigma_{00}\right)} \sigma_{32}
"""
