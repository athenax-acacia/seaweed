...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 3,0,2,0
# to recreate, then copy the file 'moment_3020.py' on top of this one.
...
def moment_3020(delta_v, mu, sigma):
    ...
    return -delta_v0**2 * (
        ...
        (mu0 + 2 * sigma_00 + 2 * sigma_30)) / 2 + delta_v0**2 * (
            2 * sigma_00 *
            ...
            (mu0 - 2 * sigma_00 + 2 * sigma_30)) - 2 * delta_v0 * (
                3 * sigma_20 *
                ...
                (sigma_00 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
                 ...
                 (-2 * sigma_00 * exp(-2 * mu3 - 2 * sigma_00 + 2 * sigma_33) *
                  ...
                  cos(2 * mu0 - 4 * sigma_30)) *
                 (mu0 + 2 * sigma_00 + 2 * sigma_30)) *
                (mu0 + 2 * sigma_00 + 2 * sigma_30)) / 2 + delta_v1**2 * (
                    2 * sigma_00 *
                    (mu0 - 2 * sigma_30) * exp(-2 * mu3 + 2 * sigma_33) +
                    (mu0 + 2 * sigma_30) *
                    ...
                    (mu2 + sigma_20 + sigma_32)) + mu2 * (
                        mu2 * (2 * mu0 * sigma_00 + mu0 *
                               (mu0**2 + sigma_00)) + 3 * sigma_20 *
                        (mu0**2 + sigma_00)) + 3 * sigma_20 * (
                            2 * mu0 * sigma_20 + mu2 *
                            (mu0**2 + sigma_00)) + sigma_22 * (
                                2 * mu0 * sigma_00 + mu0 * (mu0**2 + sigma_00))


def latex_3020():
    return r"""
\frac{1}{2} \, {\left(2 \, {\left(\mu_{0} - 2 \, \sigma_{30}\right)} \sigma_{00} e^{\left(-2 \, \mu_{3} + 2 \,
...
\sigma_{33}\right)}\right)} {\left(\mu_{0} + 2 \, \sigma_{30}\right)}\right)} {\Delta v_0}^{2} - \frac{1}{2} \,
...
{\left(\mu_{0} + 2 \, \sigma_{00} + 2 \, \sigma_{30}\right)}\right)} {\left(\mu_{0} + 2 \, \sigma_{00} + 2 \,
\sigma_{30}\right)} + 2 \, {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} \cos\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00} e^{\left(-2
\, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \, \sigma_{30}\right)\right)}
\sigma_{00}\right)} {\Delta v_0}^{2} + {\left({\left(\sigma_{00} e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \,
...
\sigma_{30}\right)\right)} \sigma_{00}\right)} {\Delta v_0} {\Delta v_1} + \frac{1}{2} \, {\left(2 \, {\left(\mu_{0} - 2
\, \sigma_{30}\right)} \sigma_{00} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} + {\left({\left(\mu_{0} + 2 \,
\sigma_{30}\right)} {\left(\mu_{0} - 2 \, \sigma_{30}\right)} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)} +
\sigma_{00} e^{\left(-2 \, \mu_{3} + 2 \, \sigma_{33}\right)}\right)} {\left(\mu_{0} + 2 \, \sigma_{30}\right)}\right)}
...
\sigma_{30}\right)\right)} {\left(\mu_{0} + 2 \, \sigma_{00} + 2 \, \sigma_{30}\right)}\right)} {\left(\mu_{0} + 2 \,
\sigma_{00} + 2 \, \sigma_{30}\right)} + 2 \, {\left({\left(\mu_{0} - 2 \, \sigma_{30}\right)} \cos\left(2 \, \mu_{0} -
4 \, \sigma_{30}\right) e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} - 2 \, \sigma_{00}
e^{\left(-2 \, \mu_{3} - 2 \, \sigma_{00} + 2 \, \sigma_{33}\right)} \sin\left(2 \, \mu_{0} - 4 \,
\sigma_{30}\right)\right)} \sigma_{00}\right)} {\Delta v_1}^{2} - 2 \, {\left({\left({\left(\sigma_{00}
...
\sigma_{00} + \sigma_{30}\right)}\right)} {\left(\mu_{0} - \sigma_{00} + \sigma_{30}\right)} + 2 \, {\left(\sigma_{00}
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{00}\right)} {\left(\mu_{2} - \sigma_{20} +
\sigma_{32}\right)} + 3 \, {\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sigma_{20}\right)} {\Delta v_0} - 2 \, {\left({\left({\left(\sigma_{00} \cos\left(\mu_{0} - \sigma_{30}\right)
...
{\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)}\right)} \sigma_{20}\right)} {\Delta v_1} +
{\left({\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{0} + 2 \, \mu_{0} \sigma_{00}\right)} \mu_{2} + 3 \,
{\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{20}\right)} \mu_{2} + 3 \, {\left({\left(\mu_{0}^{2} +
\sigma_{00}\right)} \mu_{2} + 2 \, \mu_{0} \sigma_{20}\right)} \sigma_{20} + {\left({\left(\mu_{0}^{2} +
\sigma_{00}\right)} \mu_{0} + 2 \, \mu_{0} \sigma_{00}\right)} \sigma_{22}
"""
