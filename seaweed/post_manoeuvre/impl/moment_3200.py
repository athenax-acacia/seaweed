...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 3,2,0,0
# to recreate, then copy the file 'moment_3200.py' on top of this one.
...
def moment_3200(delta_v, mu, sigma):
...
\sigma_{10}\right)} {\Delta v_0} + 2 \, {\left({\left({\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00}
...
- \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)}
\sigma_{00}\right)} {\left(\mu_{1} - \sigma_{10} + \sigma_{31}\right)} + 3 \, {\left(\sigma_{00} e^{\left(-\mu_{3} -
...
\sigma_{30}\right)}\right)} \sigma_{10}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0}^{2} + \sigma_{00}\right)}
\mu_{0} + 2 \, \mu_{0} \sigma_{00}\right)} \mu_{1} + 3 \, {\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{10}\right)}
\mu_{1} + 3 \, {\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{1} + 2 \, \mu_{0} \sigma_{10}\right)} \sigma_{10} +
{\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{0} + 2 \, \mu_{0} \sigma_{00}\right)} \sigma_{11}
"""
