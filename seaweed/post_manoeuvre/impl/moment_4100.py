...
#     sage post-manoeuvre-moments.sage --output-folder <some/temp/dir> -v --order 4,1,0,0
# to recreate, then copy the file 'moment_4100.py' on top of this one.
...
def moment_4100(delta_v, mu, sigma):
            ...
            (2 * sigma_00 *
             ...
             (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
              ...
              (sigma_00 * exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) *
               ...
               exp(-mu3 - sigma_00 / 2 + sigma_33 / 2) * sin(mu0 - sigma_30)) *
              (mu0 - sigma_00 + sigma_30)) * (mu0 - sigma_00 + sigma_30)) *
            (mu0 - sigma_00 + sigma_30)) + mu1 * (
                mu0 * (2 * mu0 * sigma_00 + mu0 *
                       (mu0**2 + sigma_00)) + 3 * sigma_00 *
                (mu0**2 + sigma_00)) + 4 * sigma_10 * (2 * mu0 * sigma_00 +
                                                       mu0 *
                                                       (mu0**2 + sigma_00))
...
\sigma_{00}\right)} {\left(\mu_{0} + \sigma_{00} + \sigma_{30}\right)} + 3 \, {\left(\sigma_{00} \cos\left(\mu_{0} -
...
\sigma_{30}\right)}\right)} \sigma_{00}\right)} {\Delta v_0} + {\left({\left({\left(\sigma_{00} e^{\left(-\mu_{3} -
...
\, \sigma_{33}\right)} \sin\left(\mu_{0} - \sigma_{30}\right)\right)} \sigma_{00}\right)} {\left(\mu_{0} - \sigma_{00} +
\sigma_{30}\right)} + 3 \, {\left(\sigma_{00} e^{\left(-\mu_{3} - \frac{1}{2} \, \sigma_{00} + \frac{1}{2} \,
...
\sigma_{00}\right)} {\Delta v_1} + {\left({\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{0} + 2 \, \mu_{0}
\sigma_{00}\right)} \mu_{0} + 3 \, {\left(\mu_{0}^{2} + \sigma_{00}\right)} \sigma_{00}\right)} \mu_{1} + 4 \,
{\left({\left(\mu_{0}^{2} + \sigma_{00}\right)} \mu_{0} + 2 \, \mu_{0} \sigma_{00}\right)} \sigma_{10}
"""
